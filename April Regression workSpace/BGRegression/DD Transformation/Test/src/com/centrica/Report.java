...
public class Report {
    ...
    public static boolean blnFailFlag;
    ...
    public static void createTestLogPath() {
        ...
        File summaryfile= new File(logPath);
        summaryfile.mkdirs();
        File screenFile= new File(LogScreenShotFolder);
        screenFile.mkdirs();
    ...
    public static void updateTestLog(String stepDescription, String stepStatus) throws AWTException {
    ...
    public static String takeScreenshot(String screenShotPath, String stepName) throws AWTException, IOException {
    /*	UIDriver uiDriver;
        UIOperation browser;
        ...
        ImageIO.write(image, "png", new File(newScreenshotPath+"\\Screenshots\\"+screenShotName));
        System.out.println("Saved screen shot (" + image.getWidth() +
        		" x " + image.getHeight() + " pixels) to file \"" +
        		newScreenshotPath+"\\Screenshots\\"+screenShotName + "\".");
