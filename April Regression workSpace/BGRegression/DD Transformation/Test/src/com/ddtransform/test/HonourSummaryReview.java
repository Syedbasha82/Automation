...
public class HonourSummaryReview {
...
@Test
  public void setUp() throws Exception {
	...
	Report.createTestLogHeader("Screnario5", "RapidSummaryReview");
...
@Parameters ({"baseUrl","username","password","initialAmount","finalAmount"})
  public void testIncrease(String baseUrl,String username,String password,String initialAmount,String finalAmount) throws Exception{
    ...
    try {
    	...
    	Report.updateTestLog("Honoured Amount Adjustment", "PASS");
    } catch (Exception e) {
		Report.updateTestLog("Honoured Amount Adjustment", "FAIL");
		failCount=true;
		testResult();
	}
