...
public class InterimAmountAdjustment {
...
@Test
  public void setUp() throws Exception {
	...
	Report.createTestLogHeader("Screnario4", "InterimAmountAdjustment");
...
@Parameters ({"baseUrl","username","password","initialAmount","finalAmount"})
  public void testIncrease(String baseUrl,String username,String password,String initialAmount,String finalAmount) throws Exception{
    ...
    try {
        ...
        Report.updateTestLog("Interim Amount Adjustment", "PASS");
    } catch (Exception e) {
		Report.updateTestLog("Interim Amount Adjustment", "FAIL");
		failCount=true;
		testResult();
	}
    try {
    ...
    try {
        ...
        Report.updateTestLog("Interim Amount Adjustment Refelection", "PASS");
    } catch (Exception e) {
		Report.updateTestLog("Interim Amount Adjustment Refelection", "FAIL");
		failCount=true;
		testResult();
	}
