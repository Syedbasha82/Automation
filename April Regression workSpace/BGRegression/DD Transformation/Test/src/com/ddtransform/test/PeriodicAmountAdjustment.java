...
public class PeriodicAmountAdjustment {
...
@Test
  public void setUp() throws Exception {
	...
	Report.createTestLogHeader("Screnario2", "PeriodicAmountAdjustment");
...
@Parameters ({"baseUrl","username","password","initialAmount","finalAmount"})
  public void testIncrease(String baseUrl,String username,String password,String initialAmount,String finalAmount) throws Exception{
    ...
    try {
    	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
    	driver.getPageSource().contains("We've changed your monthly payments from £"+ initialAmount +" to £"+ finalAmount +".");
        //driver.findElement(By.id("We've changed your monthly payments from £127.44 to £144.84."));       
    ...
    try {
    	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
    	driver.getPageSource().contains("Your payments have changed");
        //driver.findElement(By.cssSelector("We've changed your monthly payments from £127.44 to £144.84."));       
        Report.updateTestLog("Periodic Amount Adjustment Refelection", "PASS");
    } catch (Exception e) {
		Report.updateTestLog("Periodic Amount Adjustment Refelection", "FAIL");
		failCount=true;
		testResult();
	}
