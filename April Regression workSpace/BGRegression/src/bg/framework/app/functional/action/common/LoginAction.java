...
public class LoginAction {
    ...
    public LoginAction verifyMAPLoginPageCID() {
        LegacyLoginPage legacyLoginPage = new LegacyLoginPage();
        legacyLoginPage. verifyMAPLoginPageCID();
        return new LoginAction();
    }
    ...
    //// For model sales ////
    public AccountOverviewAction loginWithEmailId() {
        LegacyLoginPage legacyLoginPage = new LegacyLoginPage();
        legacyLoginPage.loginWithEmailId();
        //legacyLoginPage.loginUserDetails(userProfile);
        return new AccountOverviewAction();
    }
}
