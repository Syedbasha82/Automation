...
public class ForgotEmailAction {
    ...
    public ForgotEmailAction validateForgotEmailNew(UserProfile userProfile) {
        ForgotEmailPage forgotEmailPage = new ForgotEmailPage();
        forgotEmailPage.validateForgotEmailNew(userProfile);
        return this;
    }
    ...
    public ForgotEmailAction verifyForgotEmailTitleValidationNew(UserProfile userProfile) {
        ForgotEmailPage forgotEmailPage = new ForgotEmailPage();
        forgotEmailPage.validateForgotEmailTitleNew(userProfile);
        return this;
    }
    ...
    public ForgotEmailAction verifyEnterEmailValidationNew(UserProfile userProfile) {
        ForgotEmailPage forgotEmailPage = new ForgotEmailPage();
        forgotEmailPage.validateEnterEmailNew(userProfile);
        return this;
    }
