...
//import bg.framework.app.functional.test.reFactoring.Test;
...
public class IBAction {
	...
	public IBAction navigateToAccountSummaryPageAsv(UserProfile userProfile){		
		new IBPage().navigateToAccountSummaryPageAsv(userProfile);
		return this;
	 }
	public IBAction navigateToBookAnEngineerNow(){		
		new IBPage().navigateToBookAnEngineerNow();
		return this;
	 }
	public IBAction  chooseAppliances(){		
		new IBPage().chooseAppliances();
		return this;
	 }
	public IBAction  chooseAppliancesold(){		
		new IBPage().chooseAppliancesold();
		return this;
	 }
	public IBAction  verifyOverlay(){		
		new IBPage().verifyOverlay();
		return this;
	 }
	public IBAction  verifyOverlayOld(){		
		new IBPage().verifyOverlayOld();
		return this;
	 }
