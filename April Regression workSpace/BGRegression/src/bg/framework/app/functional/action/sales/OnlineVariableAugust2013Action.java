...
public class OnlineVariableAugust2013Action {
    ...
    public AcquisitionAction navigateTOYourOrderViaPriceFinder(){
    	OnlineVariableAugustPage priceFinder=new OnlineVariableAugustPage();
    	priceFinder.navigateToElecAcquisitionPage();
    	return new AcquisitionAction();
