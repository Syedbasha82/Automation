...
public class UpsellAction {
	...
	public UpsellAction verifyUpgradeCustomer400(String value) {
		upSellPage.verifyUpgradeCustomer400(value);
        return this;
    }
	public UpsellAction verifyUpgradeCustomer300(String value) {
		upSellPage.verifyUpgradeCustomer300(value);
        return this;
    }
	public UpsellAction verifyUpgradeCustomer300flexi(String value) {
		upSellPage.verifyUpgradeCustomer300flexi(value);
        return this;
    }
