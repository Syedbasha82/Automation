...
@XStreamAlias("GasApplianceCover")

public class GasApplianceCover {
	...
	public GasApplianceCover() {
	}

	public GasApplianceCover(String email, String password, String newemail,
