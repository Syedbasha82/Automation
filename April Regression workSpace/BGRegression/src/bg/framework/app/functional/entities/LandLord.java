...
public class LandLord {
	...
	float annualCooker;
	float annualHob;
	float packageAmountZero;
	float packageAmountFifty;
	float packageAmountNintyNine;
	float packageAmountSixty;
	...
	public float getPackageAmountZero() {
		return packageAmountZero;
	}
	
	public float getPackageAmountFifty() {
		return packageAmountFifty;
	}
	public float getPackageAmountSixty() {
		return packageAmountSixty;
	}	
	
	public float getPackageAmountNinetyNine() {
		return packageAmountNintyNine;
	}
	...
	public void setPackageAmountZero(float packageAmountZero) {
		this.packageAmountZero = packageAmountZero;
	}
	
	public void setPackageAmountFifty(float packageAmountFifty) {
		this.packageAmountFifty = packageAmountFifty;
	}
	
	public void setpackageAmountSixty(float packageAmountSixty) {
		this.packageAmountSixty = packageAmountSixty;
	}
	public void setPackageAmountNinetyNine(float packageAmountNinetyNine) {
		this.packageAmountNintyNine = packageAmountNinetyNine;
	}
