...
public class PriceSheet  {
	...
	}else if(packageCover.equals("index=2")|| postCode.equalsIgnoreCase("dn55 1pt")){
	...
	if(packageCover.equals("index=3")|| postCode.equalsIgnoreCase("dn55 1pt")){
		 price=new TestDataHelper().getLandLord("HC200L");
		
	}else if(packageCover.equals("index=3")|| postCode.equalsIgnoreCase("dn55 1pt")){
		price=new TestDataHelper().getLandLord("HC200");
		
	}
	if(packageCover.equals("index=4")|| postCode.equalsIgnoreCase("dn55 1pt")){	
		 price=new TestDataHelper().getLandLord("HC300L");
				
	}/*else if(packageCover.equals("index=4")&& postCode.equalsIgnoreCase("dn55 1pt")){
		 price=new TestDataHelper().getLandLord("HC300");
		
	}*/
	if(packageCover.equals("index=5")|| postCode.equalsIgnoreCase("dn55 1pt")){	
		 price=new TestDataHelper().getLandLord("HC400L");
		
	}else if(packageCover.equals("index=5")|| postCode.equalsIgnoreCase("dn55 1pt")){
		 price=new TestDataHelper().getLandLord("HC400");
		
	}
	System.out.println("222222222222222222222"+price.getPackageAmount());
