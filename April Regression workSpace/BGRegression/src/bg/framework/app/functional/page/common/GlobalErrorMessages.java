...
public class GlobalErrorMessages {
    ...
    public static final String ReFactoring_FirstSiteSearchError = "Sorry, we couldn't find any results";
    ...
    public static final String[] ReFactoring_ASV_IB_ErrorCode = {"error.system.banner.operation.fail",
    	"error.mobilenumber.invalid"/*,"error.page.not.valid.input.message","info.payment.heading","info.payment.detailedinfo",
    	"error.payment.unavailable.heading","error.payment.unavailable.message","info.we.missed.you.heading","info.we.missed.you.text",
    	"info.you.already.have.an.appointment","info.your.annual.visit.is.not.due.heading","info.your.annual.visit.is.not.due.text",
    	"error.premiseNumber.blank","error.premiseNumber.invalid","error.mobilenumber.invalid","error.annualvisit.not.due",
    	"info.annualvisit.no.access","info.annualvisit.outstanding","info.annualvisit.not.due.message","error.booking.confirmcall.failure",
    	"error.booking.slotscall.failure","error.booking.slots.unavailable","info.heading.noaccess","info.noaccess.message",
    	"error.booking.slotscall.failure.tabbeddisplay","error.booking.slots.unavailable.tabbeddisplay","error.booking.twohoursslot.notavailable",
    	"error.booking.preferenceslot.notavailable"*/};
    public static final String[] ReFactoring_ASV_IB_Payment_ErrorCode = {""};
    public static final String[] ReFactoring_Esmart_Yourorder_ErrorCode = {""};
    
    public static final String[] PredictNextBill_ErrorCode={
    	"error.page.invalid.account.smartlogica",
    	"error.page.not.allowed.for.ji.customer",
    	"error.page.get.lastmeter.read.call.fails",
    	"error.meter.read.taken.before.five.days",
    	"error.unable.to.read.smart.meter",
    	"error.page.not.allowed.for.inactive.accounts",
    	"error.page.latest.invoice.failed",
    	"error.page.invalid.account.smartlogica.header",
    	"error.page.invalid.account.smartlogica.subheader",
    	"error.page.manage.invoice.implausible.meter.read",
    	"error.system.generic.internal",
    	"error.page.manage.invoice.lower.estimate.meter.read",
    	"error.page.tariff.is.not.available",
    	"error.page.account.number.not.available.header",
    	"error.page.account.number.not.available.subheader",
    	"error.unable.to.read.smart.meter.header",
    	"error.unable.to.read.smart.meter.subheader",
    	"error.please.enter.your.meter.read",
    	"error.please.enter.your.gas.meter.read",
    	"error.please.enter.your.electricity.meter.read",
    	"error.please.enter.your.electricity.day.meter.read",
    	"error.please.enter.your.electricity.night.meter.read",
    	"error.meter.reading.exceptionally.high",
    	"error.sorry.information.cannot.retrieved",
    	"error.page.manage.invoice.implausible.meter.read.smart.meter"
    };
    public static final String[] ReFactoring_SMB_supplyaddressErrorCode = {"error.supplyaddress.blank"};
    public static final String[] ReFactoring_SMB_supplyaddresstempErrorCode = {"error.page.supply.address.ineligible"};
    public static final String[] ReFactoring_SMB_LoginDetailsErrorCode = {"error.username.not.authenticated",
    	"error.username.mandatory",
    	"error.password.mandatory",
    	"error.customerReferenceNumber.invalid",
    	//"registration.required.title",
    	"error.firstName.invalid",
    	"error.surname.blank.inline",
    	"error.emailAddress.blank.inline",
    	"error.password.invalid"};
    /*public static final String[] ReFactoring_SMB_RegistrationDetailsErrorCode={"error.customerReferenceNumber.invalid",
    	"registration.required.title",
    	"error.firstName.invalid",
    	"error.surname.blank.inline",
    	"error.emailAddress.blank.inline",
    	"error.password.invalid"};*/
    public static final String[] ReFactoring_SMB_PaymentDetailsErrorCode={"error.cardType.blank",
    	"payment.creditcard.cardnumberempty",
"error.cardNumber.invalid",
		"error.cardExpiryDate.blank",
		"error.cvv.invalid",
		//"elecamount.required",
		"error.cvv.blank"};    	
    	/*"payment.creditcard.cardnumberempty",
    	"expirydate.lesscurrent",
    	"payment.cvvnumber.invalid",
    	"payment.cvvnumber.empty"};*/
    public static final String[] ReFactoring_SMB_BankDetailsErrorCode={"error.bankAccountNumber.invalid",
    	"error.bankAccountNumber.invalid.inline",
    	"error.bankAccountNumber.blank",
    	"error.sortCode.invalid",
    	"error.sortCode.invalid", 
    	"error.accountHolderName.blank",
    	"error.accountHolderName.invalid",
    	"error.termsAndConditions.not.accepted"};
    	//"error.dd.terms.and.conditions.not.selected"};
    	//"error.payment.not.selected"};
    public static final String[] ReFactoring_SMB_ReviewOrderErrorCode={"error.termsAndConditions.not.accepted"};
public static final String[] DDCPS_ErrorCode={
    	"error.system.pi.operation.fail",
    	"error.payment.complete",
    	"error.directDebitDetails.invalid",
    	"error.account.balance.in.credit",
    	"error.recalculate.payment.amount.min",
    	"error.amount.min",
    	"error.cardType.blank",
    	"error.nameOnCard.invalid",
    	"error.cardNumber.invalid",
    	"error.cardExpiryDate.blank",
    	"error.cvv.blank",
    	"error.payment.complete",
    	"error.payment.exceed.try.count"
    };
    
    public static final String[] Sae_no_2Hr_Slot={"error.booking.twohoursslot.notavailable"};
    
    public static final String[] Sae_no_Pref_Slot={"error.booking.preferenceslot.notavailable"};
}
