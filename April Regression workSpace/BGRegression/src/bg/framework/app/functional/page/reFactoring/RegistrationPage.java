...
public class RegistrationPage extends BasePage {
    ...
    public void goToYourAccount() {
    	...
    	browser.wait(3000);
    	browser.clickWithXpath(regPageProperties.getProperty("RegistrationPage.ContinueAccountButton"));
    }
    
    public void goToYourAccountnew() {
    	//browser.clickWithLinkText("Continue to your account");
    	browser.wait(3000);
    	browser.clickWithXpath(regPageProperties.getProperty("RegistrationPage.ContinueAccountButtonnew"));
    	browser.wait(getWaitTime());
    	browser.wait(5000);
    	browser.wait(getWaitTime());
    	browser.wait(getWaitTime());
    	Report.updateTestLog("Account details Page is displayed successfully", "WARN");
    }
...
//    			browser.inputByXpath("//form[contains(@action,'errormessageoverrides')]//table//tbody//tr["+i+"]//td[3]/textarea","thanks");
     ...
     public void enterValidateEmailId(String Email){
    	 ...
    	 browser.clearValue(regPageProperties.getProperty("RegistrationPage.NewEmailXpath"));
    	 verifyAndInputByXpath(regPageProperties.getProperty("RegistrationPage.NewEmailXpath"),"Email Address",Email);
    	 verifyAndInputById(regPageProperties.getProperty("RegistrationPage.NewConfirmEmailXpath"),"Confirm Email Address",Email);
     ...
     public void enterValidateEmailNew(final UserProfile selfRegisterData){
    	 
    	 
    	 browser.Enteremailaddress(selfRegisterData.getEmail());
    	 browser.EnterConfirmemailaddress(selfRegisterData.getEmail());
     ...
     public void verifyRegProfileTempCustomer(String Email){
         ...
         public void registerCustomerDetailsNew(UserProfile userProfile,String accountNumber, String registerType) {
             ...
             verifyAndInputByXpath(regPageProperties.getProperty("RegistrationPage.PostCodeInputXPATH"), "PostCode", userProfile.getaddr());
             browser.wait(3000);
             Report.updateTestLog("Register Manditory Input Details Page", "WARN");
             verifyAndClickWithXpath(regPageProperties.getProperty("RegistrationPage.RegisterpageNext"),"Next");
             browser.wait(3000);
             ...
             {
            verifyAndInputById(regPageProperties.getProperty("RegisterationPage.AccNoText"),"Customer Account Number",curRegAcctnumber); 	
             Report.updateTestLog("Account Number  Details Entered successfully", "WARN");
             verifyAndClickWithXpath(regPageProperties.getProperty("RegistrationPage.AcctNumberNext"),"Next Button");
            Thread.sleep(5000);
             verifyAndInputById(regPageProperties.getProperty("RegistrationPage.loginPassword"),"Password",userProfile.getPassword());
            verifyAndClickWithXpath(regPageProperties.getProperty("RegistrationPage.Termsandconditionscheckbox01"),"Terms and Conditions");
            verifyAndClickWithXpath(regPageProperties.getProperty("RegistrationPage.Registerbutton"),"Register Button");
            Thread.sleep(5000);
