...
public class OnlineVariableAugustPage extends AZTariffPage {
    ...
    public void navigateTOYourOrderViaPriceFinder()
    {
    	if(browser.isElementVisibleWithXpath(pageProperties.getProperty("OnlineVariableAugust2013Page.CheckPrices")))
    	{
    		verifyAndClickWithXpath(pageProperties.getProperty("OnlineVariableAugust2013Page.EmergySmartAddonDual"),"Check prices");
    	}
    	if(browser.isElementVisible(pageProperties.getProperty("OnlineVariableAugust2013Page.SwitchNowPF")))
    	{
    		verifyAndClick(pageProperties.getProperty("OnlineVariableAugust2013Page.AddonES"),"EnergySmart Radio Button");
    		verifyAndClick(pageProperties.getProperty("OnlineVariableAugust2013Page.SwitchNowPF"),"Switch Now");
    	}
    }
