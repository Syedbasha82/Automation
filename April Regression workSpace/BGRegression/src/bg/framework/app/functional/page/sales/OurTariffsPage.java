...
public class OurTariffsPage extends AZTariffPage {
    ...
    public void navigateToFixedPriceMay2014Xpath() {
    	browser.wait(1000);
        if (browser.isElementVisibleWithXpath(pageProperties.getProperty("OurTariffPage.FixedPriceMay2014X"))) {
            browser.clickWithXpath(pageProperties.getProperty("OurTariffPage.FixedPriceMay2014X"));
            Report.updateTestLog("Navigate to FixedPriceMay2014 Tariff Page", "PASS");
        } else {
    ...
    public void navigateToOnlineVariableAugust2013Xpath() {

    	browser.wait(getWaitTime());
        if (browser.isElementVisibleWithXpath(pageProperties.getProperty("OurTariffPage.OnlineVariableAugust2013X"))) {
            browser.clickWithXpath(pageProperties.getProperty("OurTariffPage.OnlineVariableAugust2013X"));
            Report.updateTestLog("Navigate to OnlineVariableAugust2013 Tariff Page", "PASS");
        } 
        else 
        {
    ...
    public void navigateToClearAndSimpleXpath() {
   	 browser.wait(getWaitTime()); 

       if (browser.isElementVisibleWithXpath(pageProperties.getProperty("OurTariffPage.ClearAndSimpleX"))) {
           browser.clickWithXpath(pageProperties.getProperty("OurTariffPage.ClearAndSimpleX"));
           Report.updateTestLog("Navigate to ClearAndSimple Tariff Page", "PASS");
       } else {
