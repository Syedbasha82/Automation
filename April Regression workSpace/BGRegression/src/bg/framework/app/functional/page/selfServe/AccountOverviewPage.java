...
public class AccountOverviewPage extends BasePage {
    ...
    public void navigateToAccountSummaryPageNew01(UserProfile userProfile) {
       browser.wait(getWaitTime());
       Report.updateTestLog("Account overview Page", "WARN");
    	browser.wait(20000);
    	
    	if (browser.isElementVisibleWithXpath(pageProperties.getProperty("AccountOverviewPage.SelectAddressPage")))
		{
		verifyAndClickWithXpath(pageProperties.getProperty("AccountOverviewPage.SelectAddress").replace("Post Code",userProfile.getPostCode()), "Select Address");
		}
    	
    	
    //	Report.updateTestLog("The account overview page", "WARN");
        //verifyAndClickWithXpath((pageProperties.getProperty("AccountOverviewPage.ManageAccountXPath").replace("USERACCOUNTNUMBER",userProfile.getAccNumber())), "Account summary");
        
    	//browser.wait(10000);
    	//browser.clickWithLinkText("Manage account");
    	//verifyAndClickWithXpath(pageProperties.getProperty("AccountOverviewPage.ManageAccountButton"),"Manage Account Button");
    	browser.wait(getWaitTime());
        Report.updateTestLog("Account overview Page", "WARN");
    ...
    public void navigateToAccountSummaryPageNew02() {
        browser.wait(getWaitTime());
        Report.updateTestLog("Account overview Page", "WARN");
     	browser.wait(20000);
     	//String accTypeInApp = browser.getTextByXpath(pageProperties.getProperty("AccountOverviewPage.FuelTypeXPath").replace("NUMBER",userProfile.getAccNumber()));
     	/*browser.wait(5000);
		browser.wait(15000);*/
		verifyAndClickWithXpath(pageProperties.getProperty("EnergyUsage.EnergyUsageNew"), "Energy Usage");
     	browser.wait(10000);
     	//browser.clickWithLinkText("Manage account");
     	verifyAndClickWithXpath(pageProperties.getProperty("AccountOverviewPage.BillingLink"),"Billing Link");
     	browser.wait(5000);
     	verifyAndClickWithXpath(pageProperties.getProperty("Billing.ViewBillStatement"),"View Bill Link");
         System.out.println("2222222222222222222");
         browser.wait(5000);
       //  verifyAndClickWithXpath(pageProperties.getProperty("AccountOverviewPage.ManageAccountButton"),"Manage Account Button");
      //  String accTypeInApp = browser.getTextByXpath(pageProperties.getProperty("AccountOverviewPage.FuelTypeXPath").replace("NUMBER",userProfile.getAccNumber()));
    ...
    public void navigateToAccountSummaryPageNew03() {
        browser.wait(getWaitTime());
        Report.updateTestLog("Account overview Page", "WARN");
     	browser.wait(20000);
     	//String accTypeInApp = browser.getTextByXpath(pageProperties.getProperty("AccountOverviewPage.FuelTypeXPath").replace("NUMBER",userProfile.getAccNumber()));
    ...
    public void navigateToAccountSummaryPageNew04() {
        browser.wait(getWaitTime());
        Report.updateTestLog("Account overview Page", "WARN");
     	browser.wait(20000);
     	//String accTypeInApp = browser.getTextByXpath(pageProperties.getProperty("AccountOverviewPage.FuelTypeXPath").replace("NUMBER",userProfile.getAccNumber()));
    ...
    public void verifyAccountSummary() {
    	if(browser.isTextPresent("Your account")){
    		Report.updateTestLog("Account Summary Page is Present", "Pass");
    	}
    	else{
    		Report.updateTestLog("Account Summary Page is not Present", "FAIL");
    	}
        browser.wait(getWaitTime());
        verifyIsElementVisibleWithLinkText(pageProperties.getProperty("AccountOverviewPage.Bookanengineer"),"Book an engineer" );
        verifyIsElementVisibleWithLinkText(pageProperties.getProperty("AccountOverviewPage.ManageDirectDebit"),"Manage Direct Debit" );
        verifyIsElementVisibleWithLinkText(pageProperties.getProperty("AccountOverviewPage.Movinghome"),"Moving home" );
        verifyIsElementVisibleWithLinkText(pageProperties.getProperty("AccountOverviewPage.MorefromBritishGas"),"More from British Gas" );
        
    }
    public void verifyAccountSummaryforPend() {
    	if(browser.isTextPresent("Your account")){
    		Report.updateTestLog("Account Summary Page is Present", "Pass");
    	}
    	else{
        ...
        verifyIsElementVisibleWithLinkText(pageProperties.getProperty("AccountOverviewPage.Movinghome"),"Moving home" );
        verifyIsElementVisibleWithLinkText(pageProperties.getProperty("AccountOverviewPage.MorefromBritishGas"),"More from British Gas" );
        //verifyIsElementVisibleWithLinkText(pageProperties.getProperty("AccountOverviewPage.calendar"),"calendar" );
       // verifyIsElementVisibleWithLinkText(pageProperties.getProperty("AccountOverviewPage.status"),"status" );
       if (browser.isTextPresent("We're coming today")){
    	   Report.updateTestLog("Status is correct", "PASS");
       }
       else{
    	   Report.updateTestLog("Status is not correct", "FAIL");
       }
       
    }
    public void verifyAccountSummaryforCOMP() {
    	if(browser.isTextPresent("Your account")){
    		Report.updateTestLog("Account Summary Page is Present", "Pass");
    	}
    	else{
    ...
    public void verifyAccountSummaryforDONE() {
    	if(browser.isTextPresent("Your account")){
    		Report.updateTestLog("Account Summary Page is Present", "Pass");
    	}
    	else{
        ...
        //verifyIsElementVisibleWithLinkText(pageProperties.getProperty("AccountOverviewPage.calendar"),"calendar" );
       // verifyIsElementVisibleWithLinkText(pageProperties.getProperty("AccountOverviewPage.status"),"status" );
       if (browser.isTextPresent("All done")){
    	   Report.updateTestLog("Status is correct", "PASS");
       }
       else{
    	   Report.updateTestLog("Status is not correct", "FAIL");
    ...
    public void verifyAccountSummaryforNoSlots() {
    	if(browser.isTextPresent("Your account")){
    		Report.updateTestLog("Account Summary Page is Present", "Pass");
    	}
    	else{
        ...
        //verifyIsElementVisibleWithLinkText(pageProperties.getProperty("AccountOverviewPage.calendar"),"calendar" );
       // verifyIsElementVisibleWithLinkText(pageProperties.getProperty("AccountOverviewPage.status"),"status" );
       if (browser.isTextPresent("Your First Service is due")){
    	   Report.updateTestLog("Status is correct", "PASS");
       }
       else{
    	   Report.updateTestLog("Status is not correct", "FAIL");
    ...
    public void verifyAccountSummaryForNoServiceAccount() {
    	if(browser.isTextPresent("We are sorry but there is a problem with some of the information you have submitted.")){
    		Report.updateTestLog("Account Overview Page is Present", "Pass");
    	}
    	else{
    		Report.updateTestLog("Account View Page is not Present", "FAIL");
    	}
    }
    
    public void navigateToAccountSummaryForMoreThanOneServiceAccount(UserProfile userProfile) {
    	      browser.dynamicWaituntilClickablebyXpath(".//*[@id='deeplink_details']");
    	    	Report.updateTestLog("The account overview page", "WARN");
    	        verifyAndClickWithXpath((pageProperties.getProperty(
    	                "AccountOverviewPage.ViewAccountXPath").replace("USERACCOUNTNUMBER",
    	                 		userProfile.getAccNumber())), "View Account");
    	        browser.wait(3000);
    	        System.out.println("2222222222222222222");
    ...
    public void logout() {
    	...
    	if (browser.isElementVisibleWithXpath(pageProperties.getProperty("AccountOverviewPage.LogoutNew"))){
    		//Report.updateTestLog("Account Overview Page", "WARN");
    		browser.clickWithXpath(pageProperties.getProperty("AccountOverviewPage.LogoutNew"));
    ...
    public void navigateTOAddHomeCarePage() {
    	...
    	browser.open(ApplicationConfig.APP_BG_URL+"/ServiceProduct/HomeCare/?bgxlink_id=oam_ct_1_100019");
    }
  ...
  public void navigateToAccountSummaryPageNew(UserProfile userProfile, String status) {
	  ...
	  browser.wait(getWaitTime());*/
	  browser.open(ApplicationConfig.APP_FUSION_URL + "/Self-Service/Personal-Details-Entry/");
	  try {
		Thread.sleep(5000);
...
/* Added for BGMO start */
	...
	public void navigateToAccountSummaryPageAsv(UserProfile userProfile){
		browser.dynamicWaituntilClickablebyXpath(".//*[@id='deeplink_details']");
    	Report.updateTestLog("The account overview page", "WARN");
        verifyAndClickWithXpath((pageProperties.getProperty(
                "AccountOverviewPage.ViewAccountXPath").replace("USERACCOUNTNUMBER",
	...
	public void navigateToBookAnEngineerNow(){
		browser.clickWithLinkText("Book an engineer now");
		verifyIsElementVisibleWithXpath(pageProperties.getProperty("AccountOverviewPage.Bookanengineertofixafault"), "Book an engineer to fix a fault");
	}
	
	
	 public void verifyMDDPageCID(){
	    	String CID="dplnkdddash";
	    	String loginURL=browser.getURL();
	    	System.out.println("444444444444444444444444444444444444444444444444444"+loginURL);
	    	if(loginURL.contains(CID)){
	    		Report.updateTestLog("CID code Appended for MDD Page Successfully", "PASS");
	    	}
	    	else{
	    		Report.updateTestLog("CID code is not Appended for MDD View Page Successfully", "FAIL");
	    	}
	    	if(browser.isTextPresent("Manage your Direct Debit")){
	    		Report.updateTestLog("Deeplink of MDD Page is "+loginURL+" displayed Successfully", "PASS");
	    		Report.updateTestLog(" MDD Page displayed Successfully", "WARN");
	    	}
	    	else{
	    		Report.updateTestLog(" MDD Page displayed Successfully", "FAIL");
	    	}
	    }
	   public void verifyMAPPageCID(){
	    	...
	    	if(browser.isTextPresent("Manage your Direct Debit")){
	    		Report.updateTestLog("Deeplink of MAP Page is "+loginURL+" displayed Successfully", "PASS");
	    		Report.updateTestLog("MAP Page displayed Successfully", "WARN");
	    	}
	    	else{
	    		Report.updateTestLog("MAP Page displayed Successfully", "FAIL");
	    	}
	    }
 /* Added for BGMO end */
}