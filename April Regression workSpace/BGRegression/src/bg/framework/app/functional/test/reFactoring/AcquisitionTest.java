...
public class AcquisitionTest extends TestBase {
    ...
    public  void cASAcquisitionDualNewNectar(){     	
         ...
         new AcquisitionAction().logoutFromThankYouPage()         
	          ...
	          .verifyEshopLeadData()
	          .getEshopLeadID()
	          .verifyAuditEventID(userProfile).verifyTransActionID()
    ...
    public void OVAAcquisitionwithNectar(){    	
	     ...
	     @Test(groups = {FunctionalCategory.Acquisition , SalesRegressionAnonymous, SalesAcquisitionSimple})     
	    ...
	    @Test(groups = {FunctionalCategory.Acquisition , SalesAcquisitionSimple})    
	    public void OnlineVariableAugust2014Acquisition(){
	     ...
	     @Test(groups = {FunctionalCategory.Acquisition,SalesRegressionAnonymous})     
	    ...
	    @Test(groups = {FunctionalCategory.SalesAcquisitionSimple})	    
...
/*	                .navigateToGasAndElectricityPage()
	   ...
	   //     getCustomerDetailsToUserProfileOAM(userProfile);
	    ...
	    @Test(groups = {Acquisition, BG , SalesAcquisitionSimple})
	   ...
	   //     getCustomerDetailsToUserProfileOAM(userProfile);
	    ...
	    public void sSOGasElecDualAcquisitionClearAndSimpleTariff() {
	        Report.createTestLogHeader("Acquisition ClearAndSimple ScenarioSSO1", "SSOGasDualAcquisitionOAMSSO1");
	  ...
	  //      getCustomerDetailsToUserProfileOAM(userProfile);
	    ...
	    public void servicesGasElecDualAcquisitionClearAndSimpleTariff() {
	        Report.createTestLogHeader("Acquisition ClearAndSimple ScenarioHC1", "SSOGasDualAcquisitionOAMHC1");
	        final Acquisition acquisition = new TestDataHelper().getAcquisitionData("ElecConversion");
	    ...
	    public void wTPGasElecDualAcquisitionClearAndSimpleTariff() {
	        Report.createTestLogHeader("Acquisition ClearAndSimple ScenarioWTP1", "GasDualAcquisitionOAMWTP1");
	        final Acquisition acquisition = new TestDataHelper().getAcquisitionData("ElecConversion");
	        final UserProfile userProfile = new TestDataHelper().getUserProfile("SSOAccount");
	   //     getCustomerDetailsToUserProfileOAM(userProfile);
	        new AcquisitionAction().logoutFromThankYouPage()
	    ...
	    public void servicesGasElecDualAcquisitionFixedPriceMay2014Tariff() {
	        Report.createTestLogHeader("Acquisition ScenarioHC2", "SSOGasDualFixedPriceMay2014AcquisitionOAMHC2");
	        final Acquisition acquisition = new TestDataHelper().getAcquisitionData("ElecConversion");
	        final UserProfile userProfile = new TestDataHelper().getUserProfile("HomeServicesAccount");
	        new AcquisitionAction().logoutFromThankYouPage()
	                .navigateToLogin()
	    ...
	    public void ssoGasElecDualAcquisitionFixedPriceMay2014Tariff() {
	        Report.createTestLogHeader("Acquisition ScenarioSSO2", "SSOGasDualFixedPriceMay2014AcquisitionOAMSSO2");
	        final Acquisition acquisition = new TestDataHelper().getAcquisitionData("ElecConversion");
	        final UserProfile userProfile = new TestDataHelper().getUserProfile("SSOAccount");
	        new AcquisitionAction().logoutFromThankYouPage()
	                .navigateToLogin()
	    ...
	    public void wTpGasElecDualAcquisitionFixedPriceMay2014Tariff() {
	        Report.createTestLogHeader("Acquisition ScenarioWTP2", "SSOGasDualFixedPriceMay2014AcquisitionOAMWTP2");
	        final Acquisition acquisition = new TestDataHelper().getAcquisitionData("ElecConversion");
	   ...
	   public void servicesGasElecDualAcquisitionOETariff() {
	        Report.createTestLogHeader("AcquisitionConversion ScenarioHC3", "SSOGasDualAcquisitionOVA2013OAMHC3");
	        final Acquisition acquisition = new TestDataHelper().getAcquisitionData("ElecConversion");
	        final UserProfile userProfile = new TestDataHelper().getUserProfile("HomeServicesAccount");
	        new AcquisitionAction().logoutFromThankYouPage()
	                .navigateToLogin()
	   ...
	   public void WTPGasElecDualAcquisitionOETariff() {
	        Report.createTestLogHeader("AcquisitionConversion ScenarioWTP3", "SSOGasDualAcquisitionOVA2013OAMWTP3");
	        final Acquisition acquisition = new TestDataHelper().getAcquisitionData("ElecConversion");
	        final UserProfile userProfile = new TestDataHelper().getUserProfile("SSOAccount");
	        new AcquisitionAction().logoutFromThankYouPage()
	                .navigateToLogin()
	   ...
	   public void ssoGasElecDualAcquisitionOETariff() {
	        Report.createTestLogHeader("AcquisitionConversion ScenarioSSO3", "SSOGasDualAcquisitionOVA2013OAMSSO3");
	        final Acquisition acquisition = new TestDataHelper().getAcquisitionData("ElecConversion");
	        final UserProfile userProfile = new TestDataHelper().getUserProfile("SSOAccount");
	        new AcquisitionAction().logoutFromThankYouPage()
	                .navigateToLogin()
	    ...
	    @Test(groups = {FunctionalCategory.Acquisition,SalesRegressionOAM})
	 ...
	 //      getCustomerDetailsToUserProfileOAM(userProfile);
	   ...
	   public void fPM2014GasAndDualAcquisitionEE50() {
        ...
        public void conversionForGas() {

            Report.createTestLogHeader("Conversion Test", "GasConversionOnlineVariableAugust2013");
            final Acquisition acquisition = new TestDataHelper().getAcquisitionData("standardDualAcquisition");
            final UserProfile userProfile = new TestDataHelper().getUserProfile("GasAccount");
            getCustomerDetailsToUserProfileOAM(userProfile);
            new HomePageAction()
	    ...
	    @Test(groups = {Acquisition})
        public void conversionForEle() {

            Report.createTestLogHeader("Conversion Test", "ElectricityConversionOnlineVariableAugust2013");
            final Acquisition acquisition = new TestDataHelper().getAcquisitionData("standardDualAcquisition");
            final UserProfile userProfile = new TestDataHelper().getUserProfile("ElectricityAccount");
            getCustomerDetailsToUserProfileOAM(userProfile);
            new HomePageAction()
	    ...
	    @Test(groups = {FunctionalCategory.Acquisition})     
	    public  void acquisitionCancelDbValidation(){     	
	     	 Report.createTestLogHeader("Clear And Simple Acquisition", "Cancel Journey Review Order Page");     	
	     	 final Acquisition acquisition = new TestDataHelper().getAcquisitionData("standardDualAcquisition");
	         final UserProfile userProfile = new TestDataHelper().getUserProfile("NewUser");
	         ...
	         new AcquisitionAction().logoutFromThankYouPage()         
		          ...
		          .enterPersonalDetailsPage(acquisition, userProfile)
		          .enterCurrentServices(acquisition)     
		          .enterPaymentOptionsNewNew(acquisition)
//		          .cancelReviewOrderPage(acquisition)
	          	  .reviewOrderPageNavigation()
                  .verifyThankYouPage(userProfile)
               .verifyEshopLeadData()
                 .verifyAuditEventID(userProfile)//.verifyTransActionID()
	    ...
	    @Test(groups = {Acquisition, BG})
	    public void payAsYouGoOAMWTP() {
	        
	        Report.createTestLogHeader("PayAsYouGoEnergy WTP Account Test", "OAMJourney");
	        final Acquisition acquisition = new TestDataHelper().getAcquisitionData("Prepayment (Smartkey)");
	        final UserProfile userProfile = new TestDataHelper().getUserProfile("WTPAccount");
	       // getCustomerDetailsToUserProfileOAM(userProfile);
	        new AcquisitionAction().logoutFromThankYouPage()
	    ...
	    @Test(groups = {Acquisition, BG})
	    public void payAsYouGoOAMSSO() {
	        
	        Report.createTestLogHeader("PayAsYouGoEnergy SSO Account Test", "OAMJourney");
	        final Acquisition acquisition = new TestDataHelper().getAcquisitionData("Prepayment (Smartkey)");
	        final UserProfile userProfile = new TestDataHelper().getUserProfile("SSOAccount");
	       // getCustomerDetailsToUserProfileOAM(userProfile);
	        new AcquisitionAction().logoutFromThankYouPage()
	    ...
	    @Test(groups = {Acquisition, BG})
	    public void inactiveUserPureAcquisitionGas() {
	        
	        Report.createTestLogHeader("Inactive Gas Account Test", "OAMJourney");
	        final Acquisition acquisition = new TestDataHelper().getAcquisitionData("Prepayment (Smartkey)");
	        final UserProfile userProfile = new TestDataHelper().getUserProfile("GasAccount");
	       // getCustomerDetailsToUserProfileOAM(userProfile);
	        new AcquisitionAction().logoutFromThankYouPage()
	    ...
	    @Test(groups = {Acquisition, BG})
	    public void inactiveUserPurAcquisitionEle() {
	        
	        Report.createTestLogHeader("Inactive Ele Account Test", "OAMJourney");
	        final Acquisition acquisition = new TestDataHelper().getAcquisitionData("Prepayment (Smartkey)");
	        final UserProfile userProfile = new TestDataHelper().getUserProfile("ElectricityAccount");
	       // getCustomerDetailsToUserProfileOAM(userProfile);
	        new AcquisitionAction().logoutFromThankYouPage()
	    ...
	    @Test(groups = {Acquisition, BG})
	    public void inactiveUserPureAcquisitionDual() {
	        
	        Report.createTestLogHeader("Inactive Dual Account Test PureAcquisition", "OAMJourney");
	        final Acquisition acquisition = new TestDataHelper().getAcquisitionData("Prepayment (Smartkey)");
	        final UserProfile userProfile = new TestDataHelper().getUserProfile("DualAccount");
	       // getCustomerDetailsToUserProfileOAM(userProfile);
	        new AcquisitionAction().logoutFromThankYouPage()
	    ...
	    @Test(groups = {Acquisition, BG})
	    public void inactiveUserPureAcquisitionJI() {
	        
	        Report.createTestLogHeader("Inactive JI Account Test PureAcquisition", "OAMJourney");
	        final Acquisition acquisition = new TestDataHelper().getAcquisitionData("Prepayment (Smartkey)");
