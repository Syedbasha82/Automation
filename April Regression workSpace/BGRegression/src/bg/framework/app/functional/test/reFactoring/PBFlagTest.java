...
import bg.framework.app.functional.action.services.AccountSummaryAction;
...
public class PBFlagTest extends TestBase{
    ...
    public void pbFlagVerificationForElectricity_EmberPage() {
    ...
    public void pbFlagVerificationForGas_EmberPage() {
	...
	@Test(groups = {PBFlag,Refactoring})
    public void pbFlagVerificationForJI_EmberPage() {
	...
	@Test(groups = {PBFlag,Refactoring})
    public void pbFlagVerificationForDual_EmberPage() {
	...
	@Test(groups = {PBFlag,Refactoring})
    public void pbFlagVerification() {
        Report.createTestLogHeader("PB Flag Test", "Go paperless link verification with Nectar Registration");
        UserProfile userProfile = new TestDataHelper().getUserProfile("GasAccount");
        getCustomerDetailsToUserProfileOAM(userProfile);
        new HomePageAction()
                .navigateToLoginPage()
                .loginUserDetails(userProfile);
        new bg.framework.app.functional.action.reFactoring.AccountSummaryAction()
               .navigatelinkPaperlesslink();
               
    }
	
	// error Validation pending
	@Test(groups = {PBFlag,Refactoring})
    public void pbFlagVerificationNonUkAccount() {
        Report.createTestLogHeader("PB Flag Test", "Go paperless link verification for NonUK customer Customer with Nectar Registration");
        UserProfile userProfile = new TestDataHelper().getUserProfile("GasAccount");
        getCustomerDetailsToUserProfileOAM(userProfile);
        new HomePageAction()
                .navigateToLoginPage()
