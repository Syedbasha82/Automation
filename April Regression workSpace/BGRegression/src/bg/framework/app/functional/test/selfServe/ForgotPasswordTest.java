...
public class ForgotPasswordTest extends TestBase {
   ...
   // @Test(groups = {ForgotPassword})
    ...
    @Test(groups = {ForgotPassword})
    // Mandatory Fields to Update in Userprofile.xml: UCRN,Password
    public void verifyForgottenPasswordHistoryJourney() {
            Report.createTestLogHeader("Forgotten Password Journey", "To Verify whether Gas Account user can successfully complete Forgotten Password journey with Previos passwords");
            UserProfile userProfile = new TestDataHelper().getUserProfile("GasAccount");
            activateCustomerDetailsInOnlineDB(userProfile);
            getCustomerDetailsToUserProfileOAM(userProfile);
            new ForgotPasswordAction()
            		.verifyLastPassword(userProfile);
    }
    
    @SuppressWarnings("unchecked")
    @Test(groups = {ForgotPassword})
    // Mandatory Fields to Update in Userprofile.xml: UCRN,Password
    public void verifyForgottenPasswordJourneySECustomer() {
            Report.createTestLogHeader("Forgotten Password Journey", "To Verify whether SE Account user can successfully complete Forgotten Password journey in BG Site");
            UserProfile userProfile = new TestDataHelper().getUserProfile("SEAccount");
            activateCustomerDetailsInOnlineDB(userProfile);
            getCustomerDetailsToUserProfileOAM(userProfile);
            new HomePageAction()
                    .navigateToForgottenPasswordScreen()
    ...
    @Test(groups = {ForgotPassword})
    // Mandatory Fields to Update in Userprofile.xml: UCRN,Password
    public void verifyForgottenPasswordJourneyWTPCustomer() {
            Report.createTestLogHeader("Forgotten Password Journey", "To Verify whether WTP Account user can successfully complete Forgotten Password journey");
