...
Userprofile - AccNumber,UCRN,bgsAccount
    ...
    @SuppressWarnings(UNCHECKED)
    @Test(groups = {BGRRegistration,Refactoring})
    public void passwordValidationforRegistration() throws Exception {
        Report.createTestLogHeader("Registration", "To Verify whether the Electricity Only Account user can successfully Register with given valid password");
        UserProfile userProfile = new TestDataHelper().getUserProfile("ElectricityAccount");
        //putty.go();
        preRegister(userProfile);
        new HomePageAction()
                .navigateToRegistration()
                .registerYourDetailswithValidPassword(userProfile, userProfile.getElecAccount())
                .goToYourAccount()
                .verifyRegisteredUser(userProfile,userProfile.getLastName(), userProfile.getElecAccount())
                .verifyAccountPresense(userProfile.getElecAccount())
                .logout();
    ...
    @SuppressWarnings(UNCHECKED)
    @Test(groups = {BGRRegistration,Refactoring})
    public void verifyvolwebreg() {
    	//for (int i=1;i<1;i++){
        Report.createTestLogHeader("Registration","To Verify whether registration ");
    ...
    @SuppressWarnings(UNCHECKED)
    @Test(groups = {BGRRegistration,Refactoring })
    public void verifyFreezedAccountJourney() {
        Report.createTestLogHeader("Registration", "To Verify whether the Freezed Account user can successfully Register");
        UserProfile userProfile = new TestDataHelper().getUserProfile("ElectricityAccount");
        //activateCustomerDetailsInOnlineDB(userProfile);
        getCustomerDetailsToUserProfileAnonymous(userProfile);
        preRegister(userProfile);
    ...
    @SuppressWarnings(UNCHECKED)
    @Test(groups = {BGRRegistration,Refactoring })
    public void verifyMixedBrandCustomerJourney() {
        Report.createTestLogHeader("Registration", "To Verify whether the MixedBrand user can successfully Register");
        UserProfile userProfile = new TestDataHelper().getUserProfile("ElectricityAccount");
        //activateCustomerDetailsInOnlineDB(userProfile);
        getCustomerDetailsToUserProfileAnonymous(userProfile);
        preRegister(userProfile);
    ...
    @SuppressWarnings(UNCHECKED)
    @Test(groups = {BGRRegistration,Refactoring })
    public void verifySEAccountJourney() {
        Report.createTestLogHeader("Registration", "To Verify whether the SE user can successfully Register");
        UserProfile userProfile = new TestDataHelper().getUserProfile("ElectricityAccount");
        //activateCustomerDetailsInOnlineDB(userProfile);
        getCustomerDetailsToUserProfileAnonymous(userProfile);
        preRegister(userProfile);
