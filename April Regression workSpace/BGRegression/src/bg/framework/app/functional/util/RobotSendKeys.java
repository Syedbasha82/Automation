...
public class RobotSendKeys {
    ...
    static int keyInput[] =
            {
                    ...
                    KeyEvent.VK_C, KeyEvent.VK_O, KeyEvent.VK_M, KeyEvent.VK_UNDERSCORE,KeyEvent.VK_ESCAPE
            };
    ...
    public static void typeEscape()
    {
    	 Robot testenter;
    	try {
            testenter = new Robot();
            testenter.keyPress(KeyEvent.VK_ESCAPE);
            testenter.keyRelease(KeyEvent.VK_ESCAPE);
