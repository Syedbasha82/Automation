...
/* Added for BGMO Start */
	...
	public AccountSummaryAction verifyTILOverlay(String meterType, UserProfile userProfile){
		AccountSummaryPage accountSummaryPage = new AccountSummaryPage();
		accountSummaryPage.navigateAndVerifyTILOverlay(meterType, userProfile);
		return this;
	}
/* Added for BGMO End */
}
