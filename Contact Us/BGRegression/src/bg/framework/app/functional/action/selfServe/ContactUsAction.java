...
public class ContactUsAction {
    ...
    public ContactUsAction verifyContactUsOAMNew(UserProfile userProfile,String strType) {
        ContactUsPage contactUsPage = new ContactUsPage();
        contactUsPage.submitFormNew(userProfile,strType);
        return this;
    }
    public ContactUsAction verifyContactUsOAMNewOAM(UserProfile userProfile,String strType) {
        ContactUsPage contactUsPage = new ContactUsPage();
        contactUsPage.submitFormNewOAM(userProfile,strType);
        return this;
    }
    ...
    public ContactUsAction verifyContactUsAnonNew(UserProfile userProfile,String strType) {
        ContactUsPage contactUsPage = new ContactUsPage();
        contactUsPage.submitFormNew(userProfile,strType);
        return this;
    }
    ...
    public ContactUsAction SelectMovingHome() {
        ContactUsPage contactUsPage = new ContactUsPage();
        contactUsPage.SelectMovingHome();
        return this;
    }
}
