...
public class DdcpsAction {
	...
	public DdcpsAction fixedDDSetUpJourney(String CustType,UserProfile userProfile){
		DdcpsPage ddcps = new DdcpsPage();
		ddcps.fixedDDSetupJourney(CustType, userProfile);
		return new DdcpsAction();
	}
	public DdcpsAction navigateToDirecrDebitPage(){
		DdcpsPage ddcps = new DdcpsPage();
		ddcps.navigateToDirectDebitPage();
		return new DdcpsAction();
	}
	public DdcpsAction journeyType(String ddType,UserProfile userProfile){
		DdcpsPage ddcps = new DdcpsPage();
		ddcps.journeyType(ddType, userProfile);
		return new DdcpsAction();
	}
	}
