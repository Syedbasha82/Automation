...
public class LegacyHomePage extends BasePage {
    ...
    public void navigateToLoginPage() {
        ...
        else if(browser.isElementVisibleWithXpath(".//*[@id='mega-menu']/ul/li[4]/a")){
        	browser.clickWithXpath(".//*[@id='mega-menu']/ul/li[4]/a");
        ...
        browser.wait(getWaitTime());
    */
    	browser.open("https://10.224.70.77/Login/Login-Verify/");
    	//browser.open("https://10.224.70.44/Login/Login-Verify/");fe
    }
    ...
    public void navigateToProductsAndServicesPage() {
        ...
        if (ApplicationConfig.BRAND.equalsIgnoreCase("fusion")) {
      	  ...
      	  /* if (browser.isElementVisibleWithXpath(pageProperties.getProperty("HomePage.Products"))) {
            browser.clickWithXpath(pageProperties.getProperty("HomePage.Products"));
            Report.updateTestLog("Products And Services Link is Selected Successfully ", "PASS");
            } else {
            Report.updateTestLog("Navigate to Gas and Elecrticity page", "FAIL");
            }*/
...
/*    	if (ApplicationConfig.BRAND.equalsIgnoreCase("BG")) {
        ...
        //browser.open("https://10.224.11.204/Registration/Account-Details-Entry/Link/ID/Register/");
        }
    	else{
    		verifyAndClickWithXpath(pageProperties.getProperty("HomePage.Register"),"Register Now");
    		//browser.open("https://10.224.70.77/setup/setup-online-account/");
    	}*/
    	browser.open("https://10.224.70.111/Login/Login-Verify/");
    	
    	if(verifyIsTextPresent("Get started now", "Get started now"))
    	{
    	verifyAndClickWithLinkText("Get started now", "Get started now");
    	}
    	
    	//verifyAndClickWithLinkText("Register now", "Register now");
