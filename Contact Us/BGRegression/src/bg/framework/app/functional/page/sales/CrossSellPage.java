...
public void CrossCellCheck2() {
 ...
 public void verifyCrossSellEndToEnd(UserProfile userProfile,Acquisition acquisition) {
	    ...
	    if(browser.isElementVisibleWithXpath(".//*[@id='xsell-telephone']")){
	    	verifyAndInputByXpath(".//*[@id='xsell-telephone']","telephone Number","01234567890");
	    }
	    if(browser.isElementVisibleWithXpath(".//*[@id='xsellOrderContactdetailsButton']")){
	    verifyAndClickWithXpath(".//*[@id='xsellOrderContactdetailsButton']","Contact details Next button");
	    }
	    verifyAndClickWithXpath(".//*[@id='xsellOrderBoilerdetailsButton']","next Button");
