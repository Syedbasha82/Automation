...
public class GetAQuotePageNew extends BasePage{
	...
	public void selectFuel(){
		...
		verifyAndClick(pageProperties.getProperty("GetAQuote.NextButtonFuel"),"Next Button of fuel is clicked");
		}
		browser.wait(5000);
	}
	...
	public void verifyPPForGas(String tariff,String Combination,String PPValOnScreen){
		String PPValue = new TCRCalculationPage().verifyPPValue(tariff, Combination);
