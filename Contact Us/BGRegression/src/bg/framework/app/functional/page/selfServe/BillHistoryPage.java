...
public class BillHistoryPage extends BasePage{
	...
	verifyAndClickWithXpath(pageProperties.getProperty("BillHistory.Billing"), "Billing");
	verifyAndClickWithXpath(pageProperties.getProperty("BillHistory.History"), "BillingHistory");
