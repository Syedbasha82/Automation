 ...
 */
public class CancelAnAppointmentPage extends BasePage {

    private final static String FILE_NAME = "resources/selfServe/"+ApplicationConfig.BRAND+"CancelAnAppointment.properties";
	...
	public void cancelAppointment(UserProfile userProfile)
    {
		verifyAndClickWithLinkText(pageProperties.getProperty("CancelAnAppointment.CancelAppointmentLinkText"), "Cancel Appointment Link");
		...
		verifyAndClickWithLinkText(pageProperties.getProperty("UpgradeToSmartMeter.ReturnToYourAccount"), "Return to Your Account");
