...
public class ContactUsPage extends BasePage {
    ...
    public void submitForm(UserProfile userprofile,String strType) {
        ...
        for (int x = 1; x < enquiryDetails.size(); x++) {
            ...
            browser.wait(getWaitTime());
            browser.wait(getWaitTime());
            if(browser.isElementVisibleWithXpath(pageProperties.getProperty("ContactUsPage.Movehomebutton")))
	    	{
	    	  		Report.updateTestLog("Move Home Online button is visible", "PASS");
	    	    }
            }
    ...
    public void submitFormNew(UserProfile userprofile,String strType) {
    	browser.wait(getWaitTime());
    	browser.wait(getWaitTime());
        List<String> enquiryDetails = getCategoryList();
            int iteration=1;
            int x;
        for (x = 1; x < enquiryDetails.size(); x++) {
            browser.wait(getWaitTime());
            browser.wait(getWaitTime());
            if(browser.isElementVisible(pageProperties.getProperty("ContactUsPage.contactCategoryID"))){
            browser.selectfromDropBox("id", pageProperties.getProperty("ContactUsPage.contactCategoryID"), enquiryDetails.get(x));
            ...
            if (a) {
                ...
                for (int y = 1; y < category.size(); y++) {
                    ...
                    browser.selectfromDropBox("id", pageProperties.getProperty("ContactUsPage.contactReasonID"), category.get(y));
                    String reas = category.get(y);
                    Report.updateTestLog("*********** Iteration  : '" + iteration + "' Started ***********" + cat + " ------" + reas ,  "Done");
                    Report.updateTestLog("Category  : " + cat, "Done");
                   // String reas = category.get(y);
                    Report.updateTestLog("Reason    : " + reas, "Done");
                    //validateOverlay(cat + "," + reas,strType);
                    anonymousSubmitFormNew(userprofile,strType);
                    browser.wait(getWaitTime());
                    ContactUsConfPage confirmationPage = new ContactUsConfPage();
                    confirmationPage.VerifyContactUsConfirmationPage(userprofile, cat + "," + reas);
                    browser.wait(getWaitTime());
    ...
    public void submitFormNewOAM(UserProfile userprofile,String strType) {
    	browser.wait(getWaitTime());
    	browser.wait(getWaitTime());
        List<String> enquiryDetails = getCategoryList();
            int iteration=1;
            ...
            if (a) {
                ...
                for (int y = 1; y < category.size(); y++) {
                   ...
                   // String reas = category.get(y);
                    Report.updateTestLog("Reason    : " + reas, "Done");
                    //validateOverlay(cat + "," + reas,strType);
                    SubmitFormNewOAM(userprofile,strType);
                    browser.wait(getWaitTime());
                    ContactUsConfPage confirmationPage = new ContactUsConfPage();
                    confirmationPage.VerifyContactUsConfirmationPage(userprofile, cat + "," + reas);
                    browser.wait(getWaitTime());
    ...
    private void anonymousSubmitForm(UserProfile userprofile,String strType) {
        ...
        if (browser.isElementVisible(pageProperties.getProperty("ContactUsPage.telephoneNumber"))) {
            ...
            browser.input(pageProperties.getProperty("ContactUsPage.InternationaltelephoneNumber"), "+919742136578");
     ...
     /*   if(strType.equalsIgnoreCase("OAM")){
        if (browser.isElementVisible(pageProperties.getProperty("ContactUsPage.AccNum"))) {
            browser.selectfromDropBox("id", pageProperties.getProperty("ContactUsPage.AccNum"), userprofile.getAccNumber());
            Report.updateTestLog(userprofile.getAccNumber() + " Account Number Selected", "DONE");
        } else {
            Report.updateTestLog("Account Number Not Selected", "FAIL");
        }
        }*/
        verifyAndClick(pageProperties.getProperty("ContactUsPage.sendButton"), "Send Button");
        browser.wait(getWaitTime());
    }
    private void anonymousSubmitFormNew(UserProfile userprofile,String strType) {
        browser.clearValue(pageProperties.getProperty("ContactUsPage.contactQuery"));
        String test ="just testing" ;
        ...
        int count = test.length();
        Report.updateTestLog("Tell Us More    ::"+count+" Characters entered", "PASS");
        if (browser.isElementVisible(pageProperties.getProperty("ContactUsPage.GasMeter"))) {
           	browser.clearValue(pageProperties.getProperty("ContactUsPage.GasMeter"));
            browser.input(pageProperties.getProperty("ContactUsPage.GasMeter"),userprofile.getGasMeter());
            Report.updateTestLog(userprofile.getGasMeter() + " Gas Meter is Entered", "DONE");
        }
        else
        {
        	Report.updateTestLog(" Gas Meter is not available", "Fail");
        }
        if (browser.isElementVisible(pageProperties.getProperty("ContactUsPage.electMeter"))) {
           	browser.clearValue(pageProperties.getProperty("ContactUsPage.electMeter"));
            browser.input(pageProperties.getProperty("ContactUsPage.electMeter"),userprofile.getElectMeter());
            Report.updateTestLog(userprofile.getElectMeter() + "Elect Meter is Entered", "DONE");
        }
        else
        {
        	Report.updateTestLog(" Elect Meter is not available", "Fail");
        }
    ...
    private void SubmitFormNewOAM(UserProfile userprofile,String strType) {
        browser.clearValue(pageProperties.getProperty("ContactUsPage.contactQuery"));
        String test ="just testing" ;
    ...
    public void SelectMovingHome() {
    	Report.updateTestLog("Contact Us Page", "WARN");
    	Select select = new Select(browser.getElementByXpath(pageProperties.getProperty("ContactUsPage.SelectMovehome")));
		select.selectByIndex(4);
		browser.wait(getWaitTime());
		browser.wait(getWaitTime());
		Report.updateTestLog("Move home button is displayed", "WARN");
		verifyAndClickWithXpath(pageProperties.getProperty("ContactUsPage.Movehomebutton"), "Move Home Online");
		browser.wait(getWaitTime());
		Report.updateTestLog("Home Home Button Page", "WARN");
