...
public class AccountSummaryTest extends TestBase {
	...
	///////////////    TC Name : TC_Account_Summary_Closed_Dual_007  //////////////
	@Test(groups = {  Regression, AccountSummary,Complex ,Qtp })
	public void verifyTILOverlayForClosedDualAccount(){
		Report.createTestLogHeader("Account Summary TIL verification","For closed Dual Account");
		UserProfile userProfile = new TestDataHelper().getUserProfile("DualAccount");
		new HomePageAction()
		.navigateToLogin()
		.login(userProfile)
		.verifyLogin(userProfile.getLastName(), userProfile.getAccNumber())
		.navigateToAccountSummaryPage(userProfile)
		.verifyTILOverlay("CreditMeter",userProfile);
	}

	///////////////   TC Name : TC_Account_Summary_Closed_Elec_006 ////////////
	@Test(groups = {  Regression, AccountSummary,Complex ,Qtp })
	public void verifyTILOverlayForClosedElecAccount(){
		Report.createTestLogHeader("Account Summary TIL verification","For closed Electricity Account");
		UserProfile userProfile = new TestDataHelper().getUserProfile("ElectricityAccount");
		new HomePageAction()
		.navigateToLogin()
		.login(userProfile)
	...
	///////////////   TC Name : TC_Account_Summary_Closed_JI_008 ////////////
	@Test(groups = {  Regression, AccountSummary,Complex ,Qtp })
	public void verifyTILOverlayForClosedJIAccount(){
		Report.createTestLogHeader("Account Summary TIL verification","For closed JI Account");
		UserProfile userProfile = new TestDataHelper().getUserProfile("JIAccount");
		new HomePageAction()
		.navigateToLogin()
		.login(userProfile)
	...
	///////////////   TC Name :TC_Account_Summary_Gas_Closed_005 ////////////
	@Test(groups = {  Regression, AccountSummary,Complex ,Qtp })
	public void verifyTILOverlayForClosedGasAccount(){
		Report.createTestLogHeader("Account Summary TIL verification","For closed Gas Account");
		UserProfile userProfile = new TestDataHelper().getUserProfile("GasAccount");
		new HomePageAction()
		.navigateToLogin()
		.login(userProfile)
	...
	///////////////   TC Name : TC_Account_Summary_Gas_001 ////////////
	@Test(groups = {  Regression, AccountSummary,Complex ,Qtp })
	public void verifyTILOverlayForGasAccount(){
		Report.createTestLogHeader("Account Summary TIL verification","For Active Gas Account");
		UserProfile userProfile = new TestDataHelper().getUserProfile("GasAccount");
		new HomePageAction()
		.navigateToLogin()
		.login(userProfile)
	...
	///////////////   TC Name : TC_Account_Summary_Elec_002 ////////////
	@Test(groups = {  Regression, AccountSummary,Complex ,Qtp })
	public void verifyTILOverlayForElecAccount(){
		Report.createTestLogHeader("Account Summary TIL verification","For Active Electricity Account");
		UserProfile userProfile = new TestDataHelper().getUserProfile("ElectricityAccount");
		new HomePageAction()
		.navigateToLogin()
		.login(userProfile)
	...
	///////////////   TC Name : TC_Account_Summary_Elec_002 ////////////
	@Test(groups = {  Regression, AccountSummary,Complex ,Qtp })
	public void verifyTILOverlayForDualAccount(){
		Report.createTestLogHeader("Account Summary TIL verification","For Active Dual Account");
		UserProfile userProfile = new TestDataHelper().getUserProfile("DualAccount");
		new HomePageAction()
		.navigateToLogin()
		.login(userProfile)
	...
	///////////////   TC Name : TC_Account_Summary_Elec_002 ////////////
	@Test(groups = {  Regression, AccountSummary,Complex ,Qtp })
	public void verifyTILOverlayForEconomy7Account(){
		Report.createTestLogHeader("Account Summary TIL verification","For Economy 7 Account");
		UserProfile userProfile = new TestDataHelper().getUserProfile("Economy7Account");
		new HomePageAction()
		.navigateToLogin()
		.login(userProfile)
		.verifyLogin(userProfile.getLastName(), userProfile.getAccNumber())
		.navigateToAccountSummaryPage(userProfile)
		.verifyTILOverlay("Economy7",userProfile);
	}
