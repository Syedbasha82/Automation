...
public class ContactUsTest extends TestBase {
    ...
    public void verifyAnonymousJourney_old(){
    ...
    @SuppressWarnings("unchecked")
   @Test(groups = {Contactus,Smoke})
    public void verifyOAMJourney_old() {
    ...
    @SuppressWarnings("unchecked")
    @Test(groups = {Contactus,Smoke})
     public void VerifySelectMovingHome() {
    	   Report.createTestLogHeader("Contact Us","Anonymous Journey Page Validation");
    	    new HomePageAction()
            .navigateToContactUsPage()
            .SelectMovingHome();
...
//////////////////////////////////////////////////////////////////////October 6th Relerase ///////////////////////////////////////////////////////////////////////////////
        ...
        public void verifyAnonymousJourney(){
            ...
            new HomePageAction()
                    .navigateToContactUsPage()
                    .verifyContactUsAnonNew(userProfile,"Anonymous");
        }
        ...
        @Test(groups = {Contactus,Smoke})
         public void verifyOAMJourney() {
             ...
             new HomePageAction()
                     ...
                     .login(userProfile)
                     .navigateToContactUsPage()
                     .verifyContactUsOAMNewOAM(userProfile,"OAM");
