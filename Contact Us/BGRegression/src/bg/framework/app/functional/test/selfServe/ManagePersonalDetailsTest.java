    ...
    public void verifyOAMGasMPDUpdateJourney()
    {
        ...
        try {
            new HomePageAction()
            		...
            		.navigateToManagePersonalDetailsPage()
            		.logout()
            		.verifyMPDSapNetweaver(userProfile);
...
@Test(groups = {Regression,Complex, ManagePersonalDetails})
    public void verifyMPDCancel()
    {
    	UserProfile userProfile = new TestDataHelper().getUserProfile("GasAccount");
        Report.createTestLogHeader("Manage Personal Details", "OAM - Manage Personal Details Cancel Journey");
        String status="cancel";
            new HomePageAction()
                    .navigateToLogin()
                    .login(userProfile)
                    .navigateToAccountSummaryPageNew(userProfile,status);
    }
    
    @Test(groups = {Regression,Complex, ManagePersonalDetails})
    public void verifyMPDUpdateMultipleAccount()
    {
    	UserProfile userProfile = new TestDataHelper().getUserProfile("GasAccount");
        Report.createTestLogHeader("Manage Personal Details", "OAM - Manage Personal Details Update Journey for Multiple Account");
        String status="cancel";
            new HomePageAction()
                    .navigateToLogin()
                    .login(userProfile)
