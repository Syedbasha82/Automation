...
public class PredictNextBillTest extends TestBase {
	...
	////////////////////////////////////     RMR Changes Test cases /////////////////////////////
	
	/* TC Name : TC_PredictNextBill_Conv_elec_013
	 * To verify TCR in PNB for electricity customer with conventional meter
	 */
	
	@Test(groups={Regression})
	public void verifyTCRforElectricityCustomer(){
		Report.createTestLogHeader("PredictNextBill", "PNB for Electricity Customer with Conventional meter");
		UserProfile userProfile= new TestDataHelper().getUserProfile("ElectricityAccount");
		...
		.navigateToAccountSummaryPage(userProfile)
		.navigateToPredictNextBill("Billing",userProfile)
		.verifyTCRValue("QCC", "Elec SR","GasMeter",userProfile)
		.pnbLogout();
		
	}
	
	/* TC Name : TC_PredictNextBill_E7_016
	 * To verify TCR in PNB for JI customer with economy7 meter
	 */

	@Test(groups={Regression})
	public void verifyTCRforJIEconomy7Customer(){
		Report.createTestLogHeader("PredictNextBill", "PNB for JI Customer with economy7 meter");
		UserProfile userProfile= new TestDataHelper().getUserProfile("JIAccount");
		...
		.navigateToAccountSummaryPage(userProfile)
		.navigateToPredictNextBill("Billing",userProfile)
		.verifyTCRValue("MDD", "JI","economy7",userProfile)
		.pnbLogout();
		
	}
	
	/* TC Name : TC_PredictNextBill_Smart_Dual_014
	 * To verify TCR in PNB for Dual customer with Smart meter
	 */
	
	@Test(groups={Regression})
	public void verifyTCRforDualCustomer(){
		Report.createTestLogHeader("PredictNextBill", "PNB for Dual Customer with smart meter");
		...
		.navigateToAccountSummaryPage(userProfile)
		.navigateToPredictNextBill("Billing",userProfile)
		.verifyTCRValue("QCC", "Dual","economy7",userProfile)
		.pnbLogout();
		
	}
	
	/* TC Name : TC_PredictNextBillESmart_gas_012
	 * To verify TCR in PNB for Gas customer with energy Smart meter
	 */
	
	@Test(groups={Regression})
	public void verifyTCRforGasCustomer(){
		Report.createTestLogHeader("PredictNextBill", "PNB for Gas Customer with Energy smart meter");
		UserProfile userProfile= new TestDataHelper().getUserProfile("GasAccount");
		...
		.navigateToAccountSummaryPage(userProfile)
		.navigateToPredictNextBill("Billing",userProfile)
		.verifyTCRValue("QCC", "Gas","GasMeter",userProfile)
		.pnbLogout();
		
	}
	
	/* TC Name : TC_PredictNextBill_TOU_015
	 * To verify TCR in PNB for ToU customer with energy Smart meter
	 */
	
	@Test(groups={Regression})
	public void verifyTCRforToUCustomer(){
		Report.createTestLogHeader("PredictNextBill", "PNB for ToU Customer with Energy smart meter");
		UserProfile userProfile= new TestDataHelper().getUserProfile("JIAccount");
