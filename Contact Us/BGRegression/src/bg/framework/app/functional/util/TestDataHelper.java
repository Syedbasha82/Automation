...
import bg.framework.app.functional.entities.builders.EshopProfile;
...
public class TestDataHelper {
  ...
  private static final String BAAXMLFile = "resources/TestData/bgr/BAA.xml";
    ...
    private static final String eshopProfileXMLFile ="resources/TestData/bgr/EshopTariffNew.xml";
 ...
 private Map<String, UserProfile> allUserProfile = new HashMap<String, UserProfile>();
    ...
    private Map<String, EshopProfile> allGetEshopProfiles = new HashMap<String, EshopProfile>();
  ...
  @SuppressWarnings(value = "unchecked")
    ...
    @SuppressWarnings(value = "unchecked")
    public Map<String, EshopProfile> getallGetEshopProfiles(boolean reloadRequired){
        if (allGetEshopProfiles.isEmpty() || reloadRequired) {
        	allGetEshopProfiles = (Map<String, EshopProfile>) xStream
                    .fromXML(readTestDataXml(eshopProfileXMLFile));
        }
        return allGetEshopProfiles;
    }
...
public BoilerTypeProfile boilerTypeProfile(String profileKey) {
	...
	public EshopProfile getEshopProfile(String profileKey){
		if (allGetEshopProfiles.isEmpty()){
			getallGetEshopProfiles(false);
		}
		return allGetEshopProfiles.get(profileKey);
	}
