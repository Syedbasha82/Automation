...
public class LegacyLoginPage extends BasePage {
	...
	public LegacyLoginPage BgrloginUser(UserProfile userProfile) {	
	   	browser.wait(getWaitTime());
		BgbLoginEmail(userProfile.getEmail());
		browser.wait(10000);
		browser.wait(10000);
	...
	public void BgbLoginSubmit(){
		...
		browser.wait(getWaitTime());
		Report.updateTestLog("Account OverView Page", "Pass");
	}
	...
	public void verifyAndClickForgottenEmailLink(){
		...
		if(verifyIsTextPresent("Your account")){
			Report.updateTestLog("Your account page is displayed", "PASS");
			verifyIsElementVisibleWithXpath(pageProperties.getProperty("LoginPage.ForgottenEmaillink"), "I've forgotten my email");
			verifyAndClickWithXpath(pageProperties.getProperty("LoginPage.ForgottenEmaillink"), "I've forgotten my email");
		}
	}
