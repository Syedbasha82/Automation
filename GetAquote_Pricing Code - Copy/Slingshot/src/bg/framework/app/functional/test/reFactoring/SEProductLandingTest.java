...
import bg.framework.app.functional.action.reFactoring.SEProductLandingAction;
...
public class SEProductLandingTest extends TestBase {
	
	@SuppressWarnings("unchecked")
    @Test(groups ={Slingshot,Smoke,BGBRegistration})
	public void VerifySEProductLandingTariffPricing_AnonymousJourney() throws Exception {
	
	Report.createTestLogHeader("SE Product Landling Tariff Verification", "Anonymous Sign Up");
