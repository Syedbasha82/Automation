...
public class TestDataHelper {
    ...
    private static final String CompreTariffXMLFile = "resources/TestData/bgb/CompareTariff.xml";
    private static final String TariffListXMLFile = "resources/TestData/bgb/TariffList.xml";
   ...
   // private Map<String, UserProfile> allCarePlanprofile = new HashMap<String, CarePlanProfile>();
    ...
    private Map<String, CompareTariff> allComplareTariffProfile = new HashMap<String, CompareTariff>();
    private Map<String, TariffList> allTariffListProfile = new HashMap<String, TariffList>();
    ...
    public TestDataHelper() {
        ...
        xStream.processAnnotations(TariffList.class);
...
///////////////////////////////////////////////////////////////////////CompareTariff///////////////////////////////////////////////////////////////////////////////
@SuppressWarnings(value = "unchecked")
public Map<String, CompareTariff> getAllCompareTariff(boolean reloadRequired) {
if (allComplareTariffProfile.isEmpty() || reloadRequired) {
	allComplareTariffProfile = (Map<String, CompareTariff>) xStream.fromXML(readTestDataXml(CompreTariffXMLFile));
}
return allComplareTariffProfile;
}

////////////////////////////////////////////////////////TariffList///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
@SuppressWarnings(value = "unchecked")
public Map<String, TariffList> getAllTariffList(boolean reloadRequired) {
if (allTariffListProfile.isEmpty() || reloadRequired) {
	allTariffListProfile = (Map<String, TariffList>) xStream.fromXML(readTestDataXml(TariffListXMLFile));
}
return allTariffListProfile;
}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public CompareTariff getCompareTariffProfile(String profileKey) {

        if (allComplareTariffProfile.isEmpty()) {
        	getAllCompareTariff(false);
        }
        return allComplareTariffProfile.get(profileKey);
    }

    public TariffList getTariffListProfile(String profileKey) {

        if (allTariffListProfile.isEmpty()) {
        	getAllTariffList(false);
        }
        return allTariffListProfile.get(profileKey);
    }
