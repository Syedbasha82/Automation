...
'Dialog("Run").WinButton("OK").Click
	...
	Dialog("text:=SAP Logon 710").WinListView("nativeclass:=SysListView32").Select "aaaaaJQM"
...
Function SAPLogin()
  If SAPGuiSession("Session").SAPGuiWindow("SAP").Exist(10) Then
   ...
   If SAPGuiSession("Session").SAPGuiWindow("SAP").Exist(10) Then
		SAPGuiSession("Session").SAPGuiWindow("SAP").Maximize
		Wait(6)
		SAPGuiSession("Session").SAPGuiWindow("SAP").SAPGuiEdit("User").Set "singha70"
		SAPGuiSession("Session").SAPGuiWindow("SAP").SAPGuiEdit("Password").Set  "welcome"
		SAPGuiSession("Session").SAPGuiWindow("SAP").SAPGuiEdit("Password").SetFocus
		SAPGuiSession("Session").SAPGuiWindow("SAP").SendKey ENTER
	End If
...
'strAccountNumber= "850000009696"
   ...
   Call InvokeSAP
	...
	SAPGuiSession("Session").SAPGuiWindow("SAP Easy Access").SAPGuiOKCode("edtOKCode").Set "/nzbov"
	SAPGuiSession("Session").SAPGuiWindow("SAP Easy Access").SendKey ENTER
'	If SAPGuiSession("Session").SAPGuiWindow("Select organization").SAPGuiLabel("JAM Finance - Specia").Exist(3) Then
'			SAPGuiSession("Session").SAPGuiWindow("Select organization").SAPGuiLabel("JAM Finance - Specia").SetFocus
'			SAPGuiSession("Session").SAPGuiWindow("Select organization").SAPGuiLabel("JAM Finance - Specia").SetCaretPos 9
'			SAPGuiSession("Session").SAPGuiWindow("Select organization").SAPGuiButton("Copy   (Enter)").Click
'	End If

	'SAPGuiSession("Session").SAPGuiWindow("Customer Interaction Center").SAPGuiOKCode("OKCode").Set "/nzbov"
	'SAPGuiSession("Session").SAPGuiWindow("Customer Interaction Center").SendKey ENTER
'	If craft_getdata("Switch_To_Acc_Type") <> "" Then
'     		SAPGuiSession("Session").SAPGuiWindow("Billing Overview: Initial").SAPGuiEdit("edtContractAccount").Set craft_getdata("Switch_To_Acc_Type")
'	else
		SAPGuiSession("Session").SAPGuiWindow("Billing Overview: Initial").SAPGuiEdit("edtContractAccount").Set strAccountNumber		
'SAPGuiSession("Session").SAPGuiWindow("Billing Overview: Initial").SAPGuiEdit("edtContractAccount").Set "850000031384"
'	End If
