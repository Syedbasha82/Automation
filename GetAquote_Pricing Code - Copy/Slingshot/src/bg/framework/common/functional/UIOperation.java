...
public class UIOperation {
    ...
    public void ClickTabKeyXpath(String xpath) {
    	WebElement webElement;
    	webElement = uiDriver.findElement(By.xpath(xpath));
    ...
    public void CopytoClipboard1(String text){
    ...
    public void CopytoClipboard2(String text){
...
public void CopytoClipboard3(String text){
...
//        uiDriver.close();
    ...
    public void selectfromDropBoxByCSS(String css, String value) {
        new ControlProvider().getSelectControl(new FindByCss(css)).setValue(value);        
    }
...
public List<WebElement> getElementsByCSS(String locator){
    List<WebElement> element = uiDriver.findElements(By.cssSelector(locator));
    return element;
  }
