...
public class BusinessMovesAction {
	...
	public BusinessMovesAction enterMovingOutdate(UserProfile userProfile){
		BusinessMovesPage businessMovesPage = new BusinessMovesPage();
		businessMovesPage.enterMovingOutdate("3");
		businessMovesPage.enterPhoneNumber(userProfile);
		return this;
	}
	...
	public BusinessMovesAction enterMovingOutdetails(UserProfile userProfile){
		BusinessMovesPage businessMovesPage = new BusinessMovesPage();
		businessMovesPage.enterMovingOutdetails(userProfile);
		return this;
	}
	...
	public BusinessMovesAction verifySummaryPageNew(){
		BusinessMovesPage businessMovesPage = new BusinessMovesPage();
		businessMovesPage.verifySummaryPageNew();
		return this;
	}
...
/*	public BusinessMovesAction verifyAuditEntry_Anony(UserProfile userProfile){
	...
	public BusinessMovesAction ClickBusinessMovesOut() {
		BusinessMovesPage businessMovesPage = new BusinessMovesPage();
		businessMovesPage.clickBusinessMovesOut();
		return null;
	}
	public BusinessMovesAction enterMovingOutPostcodedetails(UserProfile userProfile) {
		BusinessMovesPage businessMovesPage = new BusinessMovesPage();
		businessMovesPage.enterMovingOutPostcodedetails(userProfile);
		return null;
	}
}
