...
public class ConnectionsandMeteringAction {
	...
	public ConnectionsandMeteringAction validateCMPageLoggedInNew(String LoggedIn, UserProfile userProfile,String strLink, String WR) {
		new ConnectionsandMeteringPage().validateCMPageLoggedInNew(LoggedIn, userProfile, strLink, WR);
		return new ConnectionsandMeteringAction();	
	...
	public ConnectionsandMeteringAction updateCMPage() {
		new ConnectionsandMeteringPage().updateCMPage();
		return new ConnectionsandMeteringAction();	
		
	}
	
	public ConnectionsandMeteringAction updateCMPageAnonymous(UserProfile userProfile) {
		new ConnectionsandMeteringPage().updateCMPageAnonymous(userProfile);
		return new ConnectionsandMeteringAction();	
