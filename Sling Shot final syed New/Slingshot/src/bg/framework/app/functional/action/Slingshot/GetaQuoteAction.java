...
public class GetaQuoteAction {
	...
	public GetaQuoteAction AnonymousElecGasVerificationOld(UserProfile userProfile){
		GetaQuotePage quote = new GetaQuotePage();
	//	quote.AnonymousGetaQuote("Elec");
		quote.AnonymousGetaQuote_diffenv("Elec");
		quote.AnonymousYourdetailspage(userProfile);
		...
		quote.validationsiteaddressnew(userProfile,"Get a business energy quote details");
		return this;
		}
	...
	public GetaQuoteAction AnonymousElecGasVerification_AddMultiAddress(UserProfile userProfile){
		GetaQuotePage quote = new GetaQuotePage();
	//	quote.AnonymousGetaQuote("Elec");
		quote.AnonymousGetaQuote_diffenv("Elec");
		quote.validationsiteaddressnew(userProfile,"Get a business energy quote details");
		quote.validationmultiaddress(userProfile,"Get a business energy quote details");
		quote.SelectDate();
		quote.AnonymousYourdetailspage(userProfile);
		quote.ContractYears();
		//quote.validationsiteaddress(userProfile,"Electricity quote: Site details");
	...
	public GetaQuoteAction AnonymousGasVerification_AddMultiAddress(UserProfile userProfile){
		GetaQuotePage quote = new GetaQuotePage();
	//	quote.AnonymousGetaQuote("Elec");
		quote.AnonymousGetaQuote_diffenv("Elec");
		quote.validationsiteaddressnew(userProfile,"Get a business energy quote details");
	...
	public GetaQuoteAction AnonymousGasVerification(UserProfile userProfile){
		GetaQuotePage quote = new GetaQuotePage();
	//	quote.AnonymousGetaQuote("Elec");
		quote.AnonymousGetaQuote_diffenv("Gas");
		quote.validationsiteaddressnew(userProfile,"Get a business energy quote details");
	...
	public GetaQuoteAction AnonymousGasVerificationExecption(UserProfile userProfile){
		GetaQuotePage quote = new GetaQuotePage();
	//	quote.AnonymousGetaQuote("Elec");
		quote.AnonymousGetaQuote_diffenv("Gas");
		quote.validationsiteaddressnew(userProfile,"Get a business energy quote details");
		...
		public GetaQuoteAction LoggedGasVerification(UserProfile userProfile){
			GetaQuotePage quote = new GetaQuotePage();
		
			quote.AnonymousGetaQuote_diffenv("Gas");
			quote.validationsiteaddressnew(userProfile,"Get a business energy quote details");
			quote.SelectDate();
			quote.Loggeddetailspage(userProfile);
			quote.ContractYears();
			//quote.validationsiteaddress(userProfile,"Electricity quote: Site details");
			
			return this;
		}
		public GetaQuoteAction LoggedElectVerification(UserProfile userProfile){
			GetaQuotePage quote = new GetaQuotePage();
		
			quote.AnonymousGetaQuote_diffenv("Elec");
			quote.validationsiteaddressnew(userProfile,"Get a business energy quote details");
			quote.SelectLoggedDate();
			quote.Loggeddetailspage(userProfile);
			quote.ContractYears();
			//quote.validationsiteaddress(userProfile,"Electricity quote: Site details");
	...
	public GetaQuoteAction Sendmyquote(){
		GetaQuotePage quote = new GetaQuotePage();
		quote.Sendmyquote();
		//quote.validationsiteaddress(userProfile,"Electricity quote: Site details");
	...
	public GetaQuoteAction VerifyGasVerification(UserProfile userProfile){
		GetaQuotePage quote = new GetaQuotePage();
	
		quote.AnonymousGetaQuote_diffenv("Gas");
		quote.verifyGasGetquotedetails(userProfile);
		quote.Gasvalidationsiteaddressnew(userProfile,"Get a business energy quote details");
		return this;
		}
	public GetaQuoteAction GAQ_AuditdetailsNew(UserProfile userProfile){
		GetaQuotePage quote = new GetaQuotePage();
