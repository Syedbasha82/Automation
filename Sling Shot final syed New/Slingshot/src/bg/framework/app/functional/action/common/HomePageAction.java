...
public class HomePageAction {
    ...
    public LoginAction navigateToHelpAndAdvicePage() {
        LegacyHomePage legacyHomePage = new LegacyHomePage();
        legacyHomePage.navigateToHelpAndAdvicePage();
        return new LoginAction();
    }
    ...
    public LoginAction BgbnavigateToLoginNew(UserProfile userProfile) {
        LegacyHomePage legacyHomePage = new LegacyHomePage();
        legacyHomePage.BgbnavigateToLoginPageNew(userProfile); //11-Dec
        return new LoginAction();
    }
    
    public LoginAction BgbnavigateCSAToLoginPage(UserProfile userProfile) {
        LegacyHomePage legacyHomePage = new LegacyHomePage();
        legacyHomePage.BgbnavigateCSAToLoginPage(userProfile); //11-Dec
        return new LoginAction();
    }

    public LoginAction RegesterCSAToLoginPage(UserProfile userProfile) {
        LegacyHomePage legacyHomePage = new LegacyHomePage();
        legacyHomePage.RegesterCSAToLoginPage(userProfile); //11-Dec
        return new LoginAction();
    }
    
    public LoginAction BgbnavigateToConnection_MeteringPage() {
        LegacyHomePage legacyHomePage = new LegacyHomePage();
        legacyHomePage.BgbnavigateToConnection_MeteringPage(); //11-Dec
        return new LoginAction();
    }
    ...
    public BgbRegistrationAction navigateLoginPage() {
        LegacyHomePage legacyHomePage = new LegacyHomePage();
        legacyHomePage.LoginPage();
        return new BgbRegistrationAction();
 }
    public BgbRegistrationAction AccountSummaryPage() {
        LegacyHomePage legacyHomePage = new LegacyHomePage();
        legacyHomePage.AccountSummaryPage();
        return new BgbRegistrationAction();
 }
