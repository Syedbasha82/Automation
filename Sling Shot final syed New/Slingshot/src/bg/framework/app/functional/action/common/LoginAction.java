...
//        legacyLoginPage.loginUserDetails(userProfile);
   ...
   public AccountSummaryAction BgbloginDetailsNew(UserProfile userProfile) {
       LegacyLoginPage legacyLoginPage = new LegacyLoginPage();
       AccountOverviewPage accOverviewpage =   new AccountOverviewPage();
       legacyLoginPage.BgbLoginEmailNew(userProfile);
//       accOverviewpage.verifyAccountDetails(userProfile);
//       legacyLoginPage.loginUserDetails(userProfile);
       return new AccountSummaryAction();
   }
...
//	    	legacyLoginPage.resetLoginTryCount(userProfile);
		...
		public AccountOverViewAction BgbloginPage() {
	        LegacyLoginPage legacyLoginPage = new LegacyLoginPage();
	        legacyLoginPage.BgbloginPage();       
	        return new AccountOverViewAction();
	    }
		...
		public LoginAction BgbnavigateToblackListedPage() {
            LegacyHomePage legacyHomePage = new LegacyHomePage();
            legacyHomePage.BgbnavigateToBlockistedPage(); 
            return this;
     }
...
public AccountSummaryAction loginWithMPDChangeData_new(UserProfile userProfile){
	LegacyLoginPage legacyLoginPage = new LegacyLoginPage();
	legacyLoginPage.loginWithMPDChangeData_new(userProfile);	    	
	return new AccountSummaryAction();
}
...
public BusinessMovesAction GOToMovingpremisesPage(){
	BusinessMovesPage businessMoves = 	new BusinessMovesPage();
	businessMoves.GOToMovingpremisesPage();
	return new BusinessMovesAction();
}
...
public AccountOverViewAction BgbloginDetailscheck(UserProfile userProfile) {
    LegacyLoginPage legacyLoginPage = new LegacyLoginPage();
    AccountOverviewPage accOverviewpage =   new AccountOverviewPage();
    //legacyLoginPage.BgbloginUser(userProfile);
...
public AccountOverViewAction clickManageAccountLink(UserProfile userProfile) {
    LegacyLoginPage legacyLoginPage = new LegacyLoginPage();
    legacyLoginPage.clickManageAccountLink(userProfile);
    return new AccountOverViewAction();
}



public AccountSummaryAction BgbloginSetupDDUser(UserProfile userProfile) {
    LegacyLoginPage legacyLoginPage = new LegacyLoginPage();
    AccountOverviewPage accOverviewpage =   new AccountOverviewPage();
    legacyLoginPage.BgbloginSetupDDUser(userProfile);
//    accOverviewpage.verifyAccountDetails(userProfile);
//    legacyLoginPage.loginUserDetails(userProfile);
    return new AccountSummaryAction();
}
public AccountSummaryAction BgbloginUserNew(UserProfile userProfile) {
    LegacyLoginPage legacyLoginPage = new LegacyLoginPage();
    legacyLoginPage.BgbloginUserNew(userProfile);
    return new AccountSummaryAction();
}
