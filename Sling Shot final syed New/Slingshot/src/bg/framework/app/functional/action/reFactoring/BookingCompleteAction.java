...
public class BookingCompleteAction {
	...
	public BookingCompleteAction navigateToIdentifyFault()
	{
		new ASVIBPage().navigateToIdentifyFault();
		return new BookingCompleteAction();
	}	
	...
	public BookingCompleteAction navigateToIdentifyFault(int intOption)
	{
		new IBPage().navigateToIdentifyFault(intOption);
		return new BookingCompleteAction();
	}
