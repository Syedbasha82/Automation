...
public class GetAPriceAction {
    ...
    public GetAPriceAction verifyAndEnterGAPAnonymousDetails() {
    ...
    public GetAPriceAction verifyAndEnterOAMGAPDetails(UserProfile userProfile) {
        GetAPricePage getaPricePage = new GetAPricePage();
        getaPricePage.fillOAMGAPDetails(userProfile);
        return this;
    }
