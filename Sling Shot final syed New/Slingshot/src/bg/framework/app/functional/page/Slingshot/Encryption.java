...
public class Encryption {
   ...
   public String encryptAndSendDatanew1(UserProfile userProfile,String Entermail ,String validation)
		      throws InstantiationException, IllegalAccessException {
	   final StringBuilder encryptData = new StringBuilder();
    if(validation.equals("CSAAGENT")){
		encryptData.append(emailAddressField);
    ...
    encryptData.append(userProfile.getAccNumber());
		...
		encryptData.append(emailAddressField);
    encryptData.append("=");
    System.out.println("NewEmail= "+userProfile.getNewEmail());
    encryptData.append(Entermail);
    encryptData.append("&");
		encryptData.append(businessPartnerOrganizationNumber);
    encryptData.append("=");
    System.out.println("BP Number= "+userProfile.getBpnumber());
    encryptData.append(userProfile.getBpnumber());
