...
// Verify whether Forgot Email Link exists and if it exists click on the Forgot Email Link and check whether it navigates to the appropriate page    
   ...
   public void VerifyForgotEmailPageFields(){
	   browser.wait(getWaitTime());
		   ...
		   //ForgotEmailPage.GetEmailButtonBoxButton
		  
            verifyAndClickWithXpath(pageProperties.getProperty("ForgotEmailPage.GetEmailButtonBoxButton"),"Forgot Email Box Button");
		   ...
		   if (browser.isElementVisibleWithXpath(pageProperties.getProperty("ForgotPasswordPage.BackToLoginButton"))){
			   Report.updateTestLog("Back to login link is displayed in the application", "WARN");
		   }
			   else {
				   
				   Report.updateTestLog("Back to login link is not displayed in the application", "FAIL");
		   }
   ...
   public String validateForgotEmailaddress(UserProfile userProfile){
	   ...
	   verifyPageTitle("Email address retrieval");   
...
// Enter the appropriate details in the fields displayed in Forgot Email Page        
    public void enterForgotEmailData(final String CustomerNumber, final String CustomerTitle, final String FirstName, final String SurName) {
    	 ...
    	 browser.wait(1000);
		   ...
		   //verifyAndClickWithXpath(pageProperties.getProperty("ForgotEmailPage.GetEmailButtonBoxButton"),"Forgot Email Box Button");
		   verifyAndClickWithXpath(pageProperties.getProperty("ForgotEmailPage.EmailOption"),"Forgot Email Box Button");
		   
		  /* WebElement element = browser.getElementByXpath(pageProperties.getProperty("ForgotEmailPage.GetEmailButtonBoxButton"));
			element.click();*/
    	...
    	verifyAndInputById(pageProperties.getProperty("ForgotEmailPage.Lastname"), "Lastname",SurName);*/
		   ...
		   verifyAndClickWithXpath(pageProperties.getProperty("ForgotEmailPage.TitleDropdownNew"), "Title");
		   
		   //verifyAndClickWithXpath(pageProperties.getProperty("ForgotEmailPage.TitleDropdownNew"), .replace("TariffName", userprofile.getTariff()), "Tariff"););
		   
		   verifyAndInputByName(pageProperties.getProperty("ForgotEmailPage.ContractAccountNumber"), "ContractAccountNumber", CustomerNumber);  
			    	//verifyAndSelectDropDownBox(pageProperties.getProperty("ForgotEmailPage.TitleDropdown"),"Title",CustomerTitle);  
		   
		   verifyAndSelectDropDownBox_xpath(pageProperties.getProperty("ForgotEmailPage.TitleDropdownNew"),"Title",CustomerTitle);
		   
		   verifyAndInputByName(pageProperties.getProperty("ForgotEmailPage.ContractAccountNumberName"), "Firstname", FirstName);
		   verifyAndInputByName(pageProperties.getProperty("ForgotEmailPage.LastnameNew"), "Lastname",SurName);
     ...
     verifyAndClickWithXpath(pageProperties.getProperty("ForgotEmailPage.GetEmailButton"), "Get email address button");
		  
	   }
    
    
    public void enterForgotEmailDataNew(UserProfile userProfile) {
   	 ...
   	 browser.wait(1000);
		  ...
		  /* WebElement element = browser.getElementByXpath(pageProperties.getProperty("ForgotEmailPage.GetEmailButtonBoxButton"));
		   ...
		   verifyAndClickWithXpath(pageProperties.getProperty("ForgotEmailPage.TitleDropdownSelect").replace("Title", userProfile.getTitle()), "Title");
		   
		   verifyAndInputByXpath(pageProperties.getProperty("ForgotEmailPage.FirstNameNew"), "FirstName", userProfile.getFirstName());
		   verifyAndInputByXpath(pageProperties.getProperty("ForgotEmailPage.LastnameNew"), "FirstName", userProfile.getLastName());
		   verifyAndInputByXpath(pageProperties.getProperty("ForgotEmailPage.AccountnumberNew"), "FirstName", userProfile.getAccNumber());
    ...
    verifyAndClickWithXpath(pageProperties.getProperty("ForgotEmailPage.GetEmailButtonNew"), "Get email address button");
    Report.updateTestLog("Email ID is displayed successfully in the application", "WARN");
	   }
   ...
   public void clickLoginLink(){
	   ...
	   if (browser.isElementVisibleWithXpath(pageProperties.getProperty("ForgotEmailPage.HomePageLoginLink"))){
		   Report.updateTestLog("Login page is displayed in the application", "WARN");
	   }
		   else {
			   
			   Report.updateTestLog("login page is not displayed in the application", "FAIL");
	   }
