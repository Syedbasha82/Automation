...
//	private final static String FILE_NAME = "resources/sales/"+ApplicationConfig.BRAND+"Acquisition.properties";
    ...
    public void errorCurrentServices() {
        ...
        browser.selectfromDropBox("id", pageProperties.getProperty("Acquisition.CurrentServicesGasmetertype"), "Please Select..");
        browser.selectfromDropBox("id", pageProperties.getProperty("Acquisition.CurrentServicesElectricitymetertype"), "Please Select..");
