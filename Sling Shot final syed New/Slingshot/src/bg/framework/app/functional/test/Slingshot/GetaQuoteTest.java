...
//TS_quotes_041	 Verify whether the functionality of the "get a quote" &  "back"  button in the site details page 	
		@Test
		public void AnonymousGAQverificationElec_old()  {
			...
			.GAQ_AuditdetailsNew(userProfile);
			}
...
//TS_quotesR_107 Verify whether the functionality of the "get a quote" &  "back"  button in the site details page 		
		@Test(groups ={})
		public void AnonymousGAQverificationGas_old()  {
			Report.createTestLogHeader("Get a Quote", "Verify whether the user able to submit the Gas quote successfully"); 	   	  
			UserProfile userProfile = new TestDataHelper().getUserProfile("AnonymousGAQgas"); 	      
			new LoginAction()
			.BgbnavigateToLogin();
...
//TS_quotes_152(E to E) Verify whether the user able to submit the Gas quote successfully by logging-in with valid credentials
	@Test(groups ={})
	public void VerifyLoggedGetaQuoteforgas_Old()  {
		...
		new GetaQuoteAction()
		.VerifyGasVerification(userProfile);
...
//TS_quotes_143(E to E) whether the user able to submit the Electricity quote successfully by logging-in with valid credentials 	
	@Test(groups ={})
	public void VerifyLoggedGetaQuoteforElec_Old()  {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////BGB - BAU - December 10th Release////////////////////////////////////////////////////////////////////////////// 
	
	@Test
	public void AnonymousGAQverificationElec_Old1()  {
		Report.createTestLogHeader("Get a Quote", "Verify whether the user able to submit the Elec quote successfully"); 	   	  
		UserProfile userProfile = new TestDataHelper().getUserProfile("AnonymousGAQelec"); 	      
		new LoginAction()
		.BgbnavigateToLogin();
		...
		.clickAuditleadtracking(userProfile);
		}
	...
	public void AnonymousGAQverificationGas_Old()  {
		...
		.BgbnavigateToLogin();
		new GetaQuoteAction()
		.AnonymousGasVerification(userProfile)
		.GAQ_AuditdetailsNew(userProfile);
		new HomePageAction()
		.navigateToCsaRegistration()
		.clickAuditleadtracking(userProfile);
...
//////////////////////////////////////////////////////////////BGB - BAU - Feb 5th Release////////////////////////////////////////////////////////////////////////////// 
		...
		@Test(groups ={})
		public void AnonymousGAQverificationGas_Old1()  {
		Report.createTestLogHeader("Get a Quote", "Verify whether the user able to submit the Gas quote successfully"); 	   	  
		UserProfile userProfile = new TestDataHelper().getUserProfile("AnonymousGAQgas"); 	      
		new LoginAction()
		.BgbnavigateToLogin();
		...
		@Test(groups ={})
		public void VerifyLoggedGetaQuoteforgas_Old1()  {
			Report.createTestLogHeader("Get a Quote", "Verify whether the user able to submit the Gas quote successfully by logging-in with valid credentials"); 	   	  
			UserProfile userProfile = new TestDataHelper().getUserProfile("GAQloggedUserforGas"); 	      
			new LoginAction()
			.BgbnavigateToLogin()
	...
	//TS_quotes_143(E to E) whether the user able to submit the Electricity quote successfully by logging-in with valid credentials 	
		@Test(groups ={})
		public void VerifyLoggedGetaQuoteforElec_Old2()  {
			Report.createTestLogHeader("Get a Quote", "whether the user able to submit the Electricity quote successfully by logging-in with valid credentials for elec"); 	   	  
			UserProfile userProfile = new TestDataHelper().getUserProfile("GAQloggedUserforElec"); 	      
			new LoginAction()
			.BgbnavigateToLogin()
...
//////////////////////////////////////////////////////////////BGB - BAU - March 12th Release//////////////////////////////////////////////////////////////////////////////
	...
	@Test
	public void AnonymousGAQverificationElec_SavedQuote()  {
	Report.createTestLogHeader("Get a Quote", "Verify whether the user able to submit the Elec quote successfully"); 	   	  
	UserProfile userProfile = new TestDataHelper().getUserProfile("AnonymousGAQelec"); 	      
	new LoginAction()
	.BgbnavigateToLogin();
	...
	@Test(groups ={})
	public void AnonymousGAQverificationGas_SavedQuote()  {
	Report.createTestLogHeader("Get a Quote", "Verify whether the user able to submit the Gas quote successfully"); 	   	  
	UserProfile userProfile = new TestDataHelper().getUserProfile("AnonymousGAQgas"); 	      
	new LoginAction()
	.BgbnavigateToLogin();
	...
	public void VerifyLoggedGetaQuoteforgas()  {
		...
		.BgbloginDetails(userProfile);
		new GetaQuoteAction()
		.LoggedGasVerification(userProfile);
	//	.VerifyGasVerification(userProfile);
	...
	public void VerifyLoggedGetaQuoteforElec()  {
		...
		.BgbloginDetails(userProfile);
		new GetaQuoteAction()
		.LoggedElectVerification(userProfile)	 
		.GAQ_Auditdetails_logged(userProfile);
	}
	
	@Test(groups ={})
	public void AnonymousGAQverificationGas_Multiplemeter()  {
	Report.createTestLogHeader("Get a Quote", "Verify whether the user able to submit the Gas quote successfully"); 	   	  
	UserProfile userProfile = new TestDataHelper().getUserProfile("GAQgasException"); 	      
	new LoginAction()
	.BgbnavigateToLogin();
	new GetaQuoteAction()
	.AnonymousGasVerificationExecption(userProfile);

	}
	
	@Test
	public void AnonymousGAQverificationElec_MultiAddress()  {
	Report.createTestLogHeader("Get a Quote", "Verify whether the user able to submit the Elec quote successfully"); 	   	  
	UserProfile userProfile = new TestDataHelper().getUserProfile("AnonymousGAQelec"); 	      
	new LoginAction()
	.BgbnavigateToLogin();
	new GetaQuoteAction()
	.AnonymousElecGasVerification_AddMultiAddress(userProfile)
	.GAQ_AuditdetailsNew(userProfile);

	}
	
	@Test(groups ={})
	public void AnonymousGAQverificationGas_MultiAddress()  {
	Report.createTestLogHeader("Get a Quote", "Verify whether the user able to submit the Gas quote successfully"); 	   	  
	UserProfile userProfile = new TestDataHelper().getUserProfile("AnonymousGAQgas"); 	      
	new LoginAction()
	.BgbnavigateToLogin();
	new GetaQuoteAction()
	.AnonymousGasVerification_AddMultiAddress(userProfile)
	.GAQ_AuditdetailsNew(userProfile);
	/*new HomePageAction()
	.navigateToCsaRegistration()
	.clickAuditleadtracking(userProfile);*/
