...
//TC_MPD 07: Verify whether customer is able to edit email address using MPD with alert options and verify 
				...
				public void verifyReminderUpdateandalertInSAPCRM(){
					...
					.clickLoginAndVerifyLoginPage()
					.loginWithMPDChangeData_new(userProfile)
					.verifyAccountDetails(userProfile)
					.resetFields(userProfile);
				}

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////BGB - BAU - October 20th Release//////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////BGBD-2682//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

// Verify whether the user is able to update new email id and without activating new email id verify whether the user is able to login with new email id				

				@Test(groups ={Slingshot,Regression,ManagePersonalDetails})
				public void verifyLoginNewEmail_withOutActiviate(){
					Report.createTestLogHeader("Manage Personal Details", "Verify whether the user update new email and without activating new email and login with new email");
					UserProfile userProfile = new TestDataHelper().getUserProfile("BGBLessthanFiveAccounts");
					new LoginAction()
					.BgbloginDetails(userProfile);
					new AccountSummaryAction()		
					...
					.bgblogout();
					new LoginAction()
					.BgbloginUserNew(userProfile);
					
				}				
	
//Verify whether the user is able to update new email id and without activating new email id verify whether the user is able to login with Old email id
				
				@Test(groups ={Slingshot,Regression,ManagePersonalDetails})
				public void verifyLoginOldEmail_withOutActiviate(){
					Report.createTestLogHeader("Manage Personal Details", "Verify whether the user update new email and without activating new email and login with old email");
					UserProfile userProfile = new TestDataHelper().getUserProfile("BGBLessthanFiveAccounts");
					new LoginAction()
					.BgbloginDetails(userProfile);
					new AccountSummaryAction()		
...
//Verify whether the user is able to update new email id and after activating new email id verify whether the user is able to login with Old email id
				
				@Test(groups ={Slingshot,Regression,ManagePersonalDetails})
				public void verifyLoginOldEmail_AfterActiviate(){
					Report.createTestLogHeader("Manage Personal Details", "Verify whether the user update new email and activating new email and login with Old email");
					UserProfile userProfile = new TestDataHelper().getUserProfile("BGBLessthanFiveAccounts");
					new LoginAction()
					.BgbloginDetails(userProfile);
					new AccountSummaryAction()		
					...
					.VerifyActivateMPD_UUID(userProfile);
					new LoginAction()
					.BgbloginDetails(userProfile);
...
//Verify whether the user is able to update new email id and after activating new email id verify whether the user is able to login with New email id
				
				@Test(groups ={Slingshot,Regression,ManagePersonalDetails})
				public void verifyLoginNewEmail_AfterActiviate(){
					Report.createTestLogHeader("Manage Personal Details", "Verify whether the user update new email and activating new email and login with Old email");
					UserProfile userProfile = new TestDataHelper().getUserProfile("BGBLessthanFiveAccounts");
					new LoginAction()
