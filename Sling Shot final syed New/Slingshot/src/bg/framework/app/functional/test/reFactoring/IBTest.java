...
public class IBTest extends TestBase {
	...
	public void ibBookingCompleteWithCOD() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").verifyAddressBook(userProfile).bookAnEngineerIB(userProfile, "IV").verifyAddress(userProfile)
				.navigateToIdentifyFault(1).navigatePriorityPage(0).verifyAddress(userProfile).selectFirstAvailableSlot().verifyAddress(userProfile)
				.reviewDetailsPage().addCOD(userProfile).verifyAddressASVIB(userProfile)
	...
	public void BookingCompleteibBookingWithASVKeepAppointment() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.selectAnAppointment().reviewDetailsPage().navigateToConfirmation()
				.navigateTrackCancelChange().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(0)
				.changeAppointment(2).selectAnyAppointment().reviewDetailsPage()
				.addCODASVIB(userProfile).navigateTrackCancelChange()
	...
	public void ibBookingWithASVDifferentAppointment() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").navigateToViewAllAppointments()
				.selectAnAppointment().reviewDetailsPage()
				.navigateToConfirmation().navigateTrackCancelChange().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPageASVIB(0)
				.changeAppointment(2).selectAnAppointment().reviewDetailsPage()
	...
	public void BookingCompleteibBookingWithBookedIBKeepAppointment() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(0)
				.selectAnyAppointment().reviewDetailsPage().navigateToConfirmationASV()
				.navigateTrackCancelChangeBook().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(0).navigatePriorityPageIB(0)
				.changeAppointment(1).reviewDetailsPage().navigateToConfirmationASV()
				.navigateTrackCancelChange().accountSummarycancelAppointment().logout();
	}
	...
	public void ibBookingForHomeCareFlexi() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.selectAnyAppointment().reviewDetailsPage()
				// .reviewDetailsPage()
	...
	public void ibBookingWithBookedIBKeepAppointment() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineerIB(userProfile,
						"IV").navigateToIdentifyFault(1).navigatePriorityPage(0)
				.selectAnAppointment("PM").reviewDetailsPage().navigateToConfirmationASV()
				.navigateTrackCancelChangeBook().bookAnEngineerIB(userProfile,
						"IV").navigateToIdentifyFault(1).navigatePriorityPage(0)
				.changeAppointment(1).reviewDetailsPage().navigateToConfirmation().verifyAddressASVIB(userProfile)
	...
	public void ibBookingWithASVKeepAppointment() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"ASV").navigateToConfirmation(userProfile, 4)
				.navigateTrackCancelChange().logoutReturn().navigateToLogin()
				.loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault().navigateToReview(1)
				.changeAppointment(1).navigateToConfirmation(userProfile, 4)
				.navigateTrackCancelChange();
	...
	public void contactDetailsIBHomeNumber() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault().navigateToReviewASV(1)
				.selectAnAppointment().checkMobileNumber(userProfile).logout();
	...
	//	new IBAction().runVBS(userProfile, "Preference");
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").verifyAddressBook(userProfile).bookAnEngineerIB(userProfile, "IV").verifyAddress(userProfile)
				.navigateToIdentifyFault(1).navigatePriorityPage(1).verifyAddress(userProfile)
				.selectAnAppointmentWeekDay("AllDay").verifyAddress(userProfile).reviewDetailsPage().verifySlot("AllDay")
				.navigateToConfirmationASV().verifySlotASVIB("AllDay").navigateTrackCancelChange().verifySlotASVIB("AllDay")
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibJourneyForStdAllDaysSlots() {
		...
		UserProfile userProfile = new TestDataHelper()
				.getUserProfile("HomeServciesAccount");
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAddressBook(userProfile).verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(0).verifyAddress(userProfile)
				.selectAnAppointmentWeekDay("AllDay").verifySlot("AllDay").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("AllDay").verifyAddressASVIB(userProfile).navigateTrackCancelChange().accountSummarycancelAppointment().logout();
	}
	...
	public void ibJourneyForPrefAllDaysSlotsElec() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(1)
				.verifyAddress(userProfile)
				.selectAnAppointmentWeekend("AllDay").verifySlot("AllDay").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("AllDay").verifyAddressIB(userProfile).navigateTrackCancelChange().verifySlot("AllDay").verifyAddressIB(userProfile)
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibCombJourneyForPrefAllDaysSlotsGasBankHolidays() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(1).verifySlot("AllDay").verifyAddress(userProfile)
				.selectAppointment("AllDay").verifySlot("AllDay").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("AllDay").verifyAddressIB(userProfile).logoutReturn().navigateToLogin()
				.loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(1)
				.changeAppointment(2).selectAppointment("AllDay").verifySlot("AllDay").verifyAddress(userProfile)
				.reviewDetailsPage().navigateToConfirmationASV().verifySlot("AllDay").verifyAddressIB(userProfile)
				.navigateTrackCancelChange().accountSummarycancelAppointment()
				.logout();
	}
	...
	public void ibCombASVJourneyForPrefAllDaysSlotsElec() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(1)
				.changeAppointment(2).verifySlot("AllDay").verifyAddress(userProfile).selectAnAppointmentWeekDay("AllDay").verifySlot("AllDay").verifyAddress(userProfile)
				.reviewDetailsPage().navigateToConfirmationASV().verifySlot("AllDay").verifyAddressIB(userProfile)
				.navigateTrackCancelChange().accountSummarycancelAppointment()
				.logout();
	}
	...
	public void ibJourneyForPrefFFDaysSlotsHc100() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(1).verifySlot("FF").verifyAddress(userProfile)
				.selectAppointment("FF").reviewDetailsPage().verifySlot("FF").verifyAddress(userProfile)
				.navigateToConfirmationASV().verifySlot("FF").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibJourneyForPrefFFDaysSlotsHc300() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAddressBook(userProfile).verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV").verifyAddress(userProfile)
				.navigateToIdentifyFault(1).verifyAddress(userProfile).navigatePriorityPage(1).verifySlot("FF").verifyAddress(userProfile)
				.selectAppointment("FF").verifySlot("FF").verifyAddress(userProfile).reviewDetailsPage().addCOD(userProfile).verifySlot("FF").verifyAddressIB(userProfile)
				.navigateTrackCancelChange()
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibCombJourneyForPrefFFDaysSlotsHc400() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault().navigateToReview(1)
				.selectAnAppointment().navigateToConfirmation(userProfile, 4)
				.navigateTrackCancelChange().logoutReturn().navigateToLogin()
				.loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineerIB(
						userProfile, "IV").navigateToIdentifyFault(1)
				.navigatePriorityPage(1).changeAppointment(2).verifySlot("FF").verifyAddress(userProfile)
				.selectAppointment("FF").verifySlot("FF").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("FF").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibJourneyForPrefFFDaysSlotsHc100Weekwend() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(1).verifySlot("FF").verifyAddress(userProfile)
				.selectAnAppointmentWeekend("FF").verifySlot("FF").verifyAddress(userProfile).reviewDetailsPage()
				.verifySlot("FF").verifyAddress(userProfile).navigateToConfirmationASV().navigateTrackCancelChange()
				.accountSummarycancelAppointment().logout();
	}
...
//------------------------------------------------------------------------------------------------------------------------
	...
	public void ibJourneyForPrefEveDaysSlotsHc100() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(1).verifySlot("EVE").verifyAddress(userProfile)
				.selectAppointment("EVE").verifySlot("EVE").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("EVE").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.accountSummarycancelAppointment().logout();
	}
	

	/*
	 * BookABreakdown_TC_07 IB Journey to check AM slots
	 * Preference slot should be turned ON HC 100 customer
	 * 
	 */
	@Test(groups = { ASVIB, Regression })
	public void ibJourneyForPrefAMDaysSlotsGACHc100() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").verifyAddressBook(userProfile).bookAnEngineerIB(userProfile, "IV").verifyAddress(userProfile)
				.navigateToIdentifyFault(1).navigatePriorityPage(1).verifySlot("AM").verifyAddress(userProfile)
				.selectAppointment("AM").verifySlot("AM").verifyAddress(userProfile).reviewDetailsPage().addGAC().verifySlot("AM").verifyAddressIB(userProfile)
				.navigateTrackCancelChange()
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibJourneyForNoPrefEveDaysWeekDaysSlotsHc100() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(1).verifySlot("EVE").verifyAddress(userProfile)
				.selectAnAppointmentWeekDay("EVE").verifySlot("EVE").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("EVE").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibJourneyForNoPrefEveDaysWeekendSlotsHc100() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(1).verifySlot("EVE").verifyAddress(userProfile)
				.selectAnAppointmentWeekend("EVE").verifySlot("EVE").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("EVE").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibJourneyForStdNoEveSlots() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(0).verifySlot("EVE").verifyAddress(userProfile)
				.selectNoAppointmentASV("EVE").logout();
	}
	...
	public void ibCombJourneyForPrefEveSlots() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineerIB(
						userProfile, "IV").navigateToIdentifyFault(1)
				.navigatePriorityPage(1).verifySlot("EVE").verifyAddress(userProfile).selectAppointment("EVE")
				.reviewDetailsPage().navigateToConfirmationASV().verifySlot("EVE").verifyAddressIB(userProfile).logoutReturn().navigateToLogin()
				.loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineerIB(
						userProfile, "IV").navigateToIdentifyFault(1)
				.navigatePriorityPage(1).changeAppointment(2).verifySlot("EVE").verifyAddress(userProfile)
				.selectAppointment("EVE").verifySlot("EVE").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("EVE").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibJourneyForPref2HRSlotsHc400F() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(0).verifySlot("PM").verifyAddress(userProfile)
				.selectAnAppointmentWeekDay("PM").verifySlot("PM").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("PM").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibJourneyForPref2HRSlotsHc100() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(1).verifySlot("PM").verifyAddress(userProfile)
				.selectAnAppointmentWeekDay("PM").verifySlot("PM").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("PM").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibJourneyForStdPMSlotsHc400F() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(1).verifySlot("PM").verifyAddress(userProfile)
				.selectAnAppointmentWeekend("PM").verifySlot("PM").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("PM").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibJourneyForPriorityPMSlotsHc400Elec() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(1).verifySlot("PMElec").verifyAddress(userProfile)
				.selectAppointmentASV("PMElec").logout();
	}
	...
	public void ibCombASVJourneyForPriorityPMSlotsHc100() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(1).verifySlot("PM").verifyAddress(userProfile)
				.selectAppointmentASV("PM").logout();
	}
	...
	public void ibBS2JourneyForPriorityPMSlots() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.verifyFaultPage().clickFaultCategory("Home Electrics")
				.clickFaultItemCheck().navigateToPriority()
				.navigatePriorityPage(1).verifySlot("PM").verifyAddress(userProfile).selectAppointment("PM")
				.verifySlot("PM").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("PM").verifyAddress(userProfile).logout();
	}
	...
	public void ibBankHolidayJourneyForPriorityPMSlots() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(1).verifySlot("PM").verifyAddress(userProfile)
				.selectAppointment("PM").verifySlot("PM").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("PM").verifyAddress(userProfile).logout();
	}
	...
	public void ibJourneyForPrior2HRSlotsHc1008to10() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(1).verifySlot("2HR8to10").verifyAddress(userProfile)
				.selectAnAppointmentWeekDay("2HR8to10").verifySlot("2HR8to10").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("2HR8to10").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibJourneyForPrior2HRSlotsHc2002to4() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(1).verifySlot("2HR4to6").verifyAddress(userProfile)
				.selectAnAppointmentWeekDay("2HR4to6").verifySlot("2HR4to6").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("2HR4to6").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibJourneyForSTD2HRSlotsHc3008to10() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(0).verifySlot("2HR4to6").verifyAddress(userProfile)
				.selectAnAppointmentWeekDay("2HR8to10").verifySlot("2HR4to6").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("2HR4to6").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibJourneyForSTD2HRSlotsHc1004to6() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(0).verifySlot("2HR4to6").verifyAddress(userProfile)
				.selectAnAppointmentWeekDayASV("2HR4to6").logout();
	}
	...
	public void ibJourneyForPrior2BS2HRSlotsHc4004to6() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.verifyFaultPage().clickFaultCategory("Home Electrics")
				.clickFaultItemCheck().navigateToPriority()
				.navigatePriorityPage(1).verifySlot("2HR4to6").verifyAddress(userProfile).selectAnAppointmentWeekDayASV(
						"2HR4to6").logout();
	}
	...
	public void ibJourneyForPrior2HRSlotsHc100Weekend() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(1).verifySlot("2HR4to6").verifyAddress(userProfile)
				.selectAnAppointmentWeekendASV("2HR4to6").verifySlot("2HR4to6").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("2HR4to6").verifyAddressIB(userProfile)
				.navigateTrackCancelChange().accountSummarycancelAppointment()
				.logout();
	}
	...
	public void ibJourneyForStd2HRSlotsHc100Weekend() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.navigateToIdentifyFault(1).navigatePriorityPage(0).verifySlot("2HR4to6").verifyAddress(userProfile)
				.selectAnAppointmentWeekendASV("2HR4to6").verifySlot("2HR4to6").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("2HR4to6").verifyAddressIB(userProfile).navigateTrackCancelChange().accountSummarycancelAppointment()
				.logout();
	}
	...
	public void ibBookingWithBookedIBKeepAppointmentNoPrior() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault().navigateToReview(1)
				.changeAppointment(1).navigateToConfirmation(userProfile, 1)
				.navigateTrackCancelChange();
	...
	public void ibBookingWithBookedIBKeepAppointment1stPriorY() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.reviewDetailsPage().navigateToConfirmationASV().logoutReturn()
				.navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineerIB(
						userProfile, "IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASV(0).changeAppointment(1)
	...
	public void ibBookingWithBookedIBKeepAppointment2ndPriorY() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.navigateToAccountSummaryPageASV().bookAnEngineerIB(
						userProfile, "IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASV(1).changeAppointment(1)
				.reviewDetailsPage().navigateToConfirmation()
				.navigateTrackCancelChange().logout();
	...
	public void ibBookingWithBookedIBDiffAppointmentNoPrior() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault().navigateToReview(1)
				.changeAppointment(2).selectAnAppointment()
	...
	public void RescheduleIbBookingWithBookedIBWithPrior() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault().navigateToReviewIB(1)
				.selectAnyAppointmentASV().navigateToConfirmation(userProfile, 4)
				.navigateTrackCancelChange().logoutReturn().navigateToLogin()
				.loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault().navigateToReview(1)
				.changeAppointmentIB(1).reviewDetailsPage().navigateToConfirmationASV()
				.navigateTrackCancelChangeIB().accountSummaryChange()
				.navigatePriorityPage(2).selectAnyAppointment()
				.reviewDetailsPage().navigateToConfirmationASV().logout();
	}
	...
	public void rescheduleIbBookingWithASV() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.navigateToIdentifyFault().navigateToReview(1)
				.changeAppointment(2).selectAnAppointment().reviewDetailsPage()
				.addCOD(userProfile).navigateTrackCancelChangeIB()
				.accountSummaryChange().navigatePriorityPage(2)
				.selectAnyAppointment().navigateToConfirmationASV().logout();
	...
	public void RescheduleIbBookingWithBookedIBWithoutPrior() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.navigateToIdentifyFault(1).navigatePriorityPage(1)
				.selectAnyAppointment().reviewDetailsPage()
				.navigateToConfirmationASV().logoutReturn().navigateToLogin()
				.loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineerIB(
						userProfile, "IV").navigateToIdentifyFault(1)
				.navigatePriorityPage(1).selectAnyAppointment()
				.reviewDetailsPage().navigateToConfirmationASV()
				.navigateTrackCancelChangeIB().accountSummaryChange()
				.navigatePriorityPage(2).selectAnyAppointment()
				.navigateToConfirmationASV().logout();
	}
	...
	public void emergencyMessageIBHc200() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(3)
				.verifyEmergencyMessageASV(0).logout();
	}
	...
	public void emergencyMessageIBHc400() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(0)
				.selectAnyAppointment().verifyEmergencyMessageASV(4).logout();
	}
	...
	public void oNOffIBBothOn() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(3)
				.verifyPriorityPageASV("1a").logout();
	}
	...
	public void oNOffIBElecON() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(3)
				.verifyPriorityPageASV("1b").logout();
	}
	 ...
	 */
	@Test(groups = { ASVIB, Regression })
	public void questionIBHc200() {
		Report.createTestLogHeader("Question Hc 200-IB Journey Test",
				"HomeSerivcesAccount");
		UserProfile userProfile = new TestDataHelper()
				.getUserProfile("HomeCare200Account");
	...
	public void othersIBChangeAppointmentHc100() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.navigateToAccountSummaryPageASV().bookAnEngineerIB(
						userProfile, "IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASV(0).changeAppointment(1)
				.reviewDetailsPageIB().clickChangeAppointment()
				.checkCalendarPage();
	...
	public void othersIBChangeApplianceHc200() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.navigateToAccountSummaryPageASV().bookAnEngineerIB(
						userProfile, "IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASV(0).changeAppointment(1)
				.reviewDetailsPageIB().clickChangeAppliance()
				.checkCalendarPage().logout();
	...
	public void ibBookingControls() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault().navigateToReview(1)
				.selectAnAppointmentBookingCtrlOff().reviewDetailsPage()
				.navigateToConfirmation(userProfile, 4)
				.confirmationImageCheck().navigateTrackCancelChange().logout();
	}
	...
	public void ibOffCombinedASVONBookingControls() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.navigateToIdentifyFault().navigateToReview(1)
				.selectAnAppointmentBookingCtrlOff().reviewDetailsPage()
				.navigateToConfirmation().confirmationImageCheck()
				.navigateTrackCancelChange().accountSummarycancelAppointment()
				.logout();
	...
	public void allDayKAC() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineerIB(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPage(1)
				.selectNoSlotWeekEndBankHoliday("AllDay").logout();
	}
	...
	public void ibBookingCancelFromView() {
		Report.createTestLogHeader(
				"IB - 6PM - 8PM appointment - Homeservice 300 Excess account",
				"HomeSerivcesAccount");
		UserProfile userProfile = new TestDataHelper()
				.getUserProfile("HomeCare300Account");
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault().navigateToReviewIB(1).verifySlot("EVE").verifyAddress(userProfile)
				.selectAnAppointment("EVE").verifySlot("EVE").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("EVE").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.viewDetailsCompletePage(userProfile).verifySlot("EVE").verifyAddressIB(userProfile)
	...
	public void ibBookingCancel() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault().navigateToReviewIB(1).verifySlot("FF").verifyAddress(userProfile)
				.selectAnAppointment("FF").verifySlot("FF").verifyAddress(userProfile).reviewDetailsPage().addGAC()
				.navigateToConfirmationASV().verifySlot("FF").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.viewDetailsCompletePage(userProfile).verifySlot("FF").verifyAddressIB(userProfile)
				.accountSummarycancelAppointmentViewDetail().logout();
	...
	public void ibBookingChangeFromReview() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault().navigateToReviewIB(1)
				.clickChangeAppliance().verifyFaultPage().logout();
	}
	...
	public void ibBookingChangeFromReviewPrior() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASV(1).navigateToReviewIB(1).verifySlot("AM").verifyAddress(userProfile)
				.selectAnAppointment("AM").verifySlot("AM").verifyAddress(userProfile).clickChangeAppointment()
				.verifyFaultPage().verifyAddress(userProfile)
				.logout();
	}
	...
	public void ibBookingChangeApplianceFromReviewPrior() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASVIB(1).verifySlot("EVE").verifyAddress(userProfile)
				.selectAnAppointment("EVE").verifySlot("EVE").verifyAddress(userProfile).clickChangeAppliance().verifyAddress(userProfile)
	...
	public void ibBookingHC300PMSlotPrior() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASV(1).navigateToReviewIB(1).verifySlot("PM").verifyAddress(userProfile)
				.selectAnAppointment("PM").verifySlot("PM").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("PM").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibBookingChangeFromReviewStd() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASV(0).navigateToReviewIB(1).verifySlot("AM").verifyAddress(userProfile)
				.selectAnAppointment("AM").verifySlot("AM").verifyAddress(userProfile).clickChangeAppointment()
	...
	public void ibBookingChangeApplianceFromReviewStd() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASV(0).navigateToReviewIB(1).verifySlot("10to12").verifyAddress(userProfile)
				.selectAnAppointment("10to12").verifySlot("10to12").verifyAddress(userProfile).clickChangeAppliance()
				.verifyAddress(userProfile).verifyFaultPage().logout();
	}
	...
	public void ibBookingHC2002to4Slot() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault().navigateToReviewIB(1).verifySlot("PM2to4").verifyAddress(userProfile)
				.selectAnAppointment("PM2to4").verifySlot("PM2to4").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("PM2to4").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibBookingHC300PMSlot() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault().navigateToReviewIB(1).verifySlot("PM").verifyAddress(userProfile)
				.selectAnAppointment("PM").verifySlot("PM").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("PM").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibBookingHC200FirstSlot() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault().navigateToReviewIB(1)
				.navigateToReview().reviewDetailsPage()
	...
	public void ibBookingHC200AmSlotGAC() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASV(1).navigateToReviewIB(1).verifySlot("AM").verifyAddress(userProfile)
				.selectAnAppointment("AM").verifySlot("AM").verifyAddress(userProfile).reviewDetailsPage().addGAC()
				.navigateToConfirmationASV().verifySlot("AM").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.accountSummarycancelAppointment().logout();
	}
	...
	/*
	 * Linking_TC_02 IB Journey  - Change Appointment HC300
	 * customer
	 * 
	 */
	@Test(groups = { ASVIB, Regression })
	public void ibLinkingChangeAppointmentFromReview() {
		...
		new HomePageAction().navigateToLogin()
				.loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAddressBook(userProfile).bookAnEngineer(userProfile,
						"IV").verifyAddressBook(userProfile).navigateToIdentifyFault(1)
				.navigatePriorityPageASV(0)
				.continueWithASV().verifySlot("AM").verifyAddress(userProfile).selectAnAppointment("AM")
				.verifySlot("AM").verifyAddress(userProfile)
				.reviewDetailsPage().clickChangeAppointment().verifyAddress(userProfile)
				.verifyCalendarPageASVIB()
				.logout();
	}
	...
	public void ibLinkingChangeApplianceFromReview() {
		...
		.navigateToAccountSummaryPageASV().verifyAddressBook(userProfile).bookAnEngineer(userProfile,
				"IV").verifyAddressBook(userProfile).navigateToIdentifyFault(1)
		.navigatePriorityPageASV(0)
		.continueWithASV().verifySlot("AM").verifyAddress(userProfile).selectAnAppointment("AM").verifySlot("AM").verifyAddress(userProfile)
		.reviewDetailsPage().clickChangeAppliance().verifyAddress(userProfile)
		.verifyFaultPage()
		.logout();
	}
	...
	public void ibLinkingChangeFromCalendar() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").verifyAddressBook(userProfile).navigateToIdentifyFault(1).navigatePriorityPageASVIB(0).continueWithASVIB()
				.clickChangeAppliance().verifyAddress(userProfile).verifyFaultPage().logout();
	}
	...
	public void ibLinkingChangeAppointmentFromReviewPrior() {
		...
		new HomePageAction().navigateToLogin()
				...
				.navigateToAccountSummaryPageASV().verifyAddressBook(userProfile).bookAnEngineer(userProfile,
						"IV").verifyAddressBook(userProfile).navigateToIdentifyFault(1)
				.navigatePriorityPageASV(1).continueWithASV().verifyAddress(userProfile).verifySlot("EVE").verifyAddress(userProfile)
				.selectAnAppointment("EVE").verifySlot("EVE").verifyAddress(userProfile).reviewDetailsPage()
				.clickChangeAppointment().verifyAddress(userProfile).verifyCalendarPageASVIB()
				.logout();
	...
	public void ibLinkingChangeApplianceFromReviewStd() {
		...
		new HomePageAction().navigateToLogin()
				...
				.navigateToAccountSummaryPageASV().verifyAddressBook(userProfile).bookAnEngineer(userProfile,
						"IV").verifyAddressBook(userProfile).navigateToIdentifyFault(1)
				.navigatePriorityPageASV(1).continueWithASV().verifySlot("PMElec").verifyAddress(userProfile)
				.verifyCalendarPage().selectAnAppointment("PMElec").verifySlot("PMElec").verifyAddress(userProfile).clickChangeAppliance().verifyAddress(userProfile)
				.verifyFaultPageASVIB()
				.logout();
	...
	public void ibLinkingASVdueGAC() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.selectAnAppointment("PM2to4").verifySlot("PM2to4").verifyAddress(userProfile).verifyAddress(userProfile)
				.reviewDetailsPage().verifySlot("PM2to4").verifyAddress(userProfile).navigateToConfirmationASV()
				.verifySlot("PM2to4").verifyAddressIB(userProfile).navigateTrackCancelChange().accountSummarycancelAppointment()
				.logout();
	...
	public void ibLinkingASVdueCOD() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.continueWithASV().verifySlot("12to2").verifyAddress(userProfile)
				.selectAnAppointment("12to2").verifySlot("12to2").verifyAddress(userProfile)
				.reviewDetailsPage().verifySlot("12to2").verifyAddress(userProfile).addCOD(userProfile)
				.verifySlot("12to2").verifyAddress(userProfile).navigateToConfirmationASV()
				.navigateTrackCancelChange().accountSummarycancelAppointment()
				.logout();
	...
	public void ibLinkingASVdueALLOCStatus() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAddressBook(userProfile).bookAnEngineer(userProfile,
						"IV").verifyAddressBook(userProfile).navigateToIdentifyFault(1).navigatePriorityPageASV(0)
				.continueWithASV().verifyAddress(userProfile).testHornors()/*selectAnAppointment("AM").verifyAddress(userProfile)
				.reviewDetailsPage().navigateToConfirmationBooking()
	...
	public void ibLinkingASVdueHOLDStatus() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault().navigateToReview(1)
				.continueWithASV().verifySlot("AM").verifyAddress(userProfile).selectAnAppointment("AM")
				.verifySlot("AM").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmation()
				.verifyAddress(userProfile).verifySlotASVIB("AM").navigateTrackCancelChangeBook().verifyAccountOverviewASV("Hold")
				.accountSummarycancelAppointment().logout();
	...
	public void ibLinkingASVdueSITEStatus() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault().navigateToReviewBook(1)
				.continueWithASV().verifyAddress(userProfile).verifySlot("AllDay").selectAnAppointment("AllDay")
				.verifyAddress(userProfile).verifySlot("AllDay").reviewDetailsPage().navigateToConfirmation()
				.verifyAddress(userProfile).verifySlotASVIB("AllDay").navigateTrackCancelChangeBook().verifyAccountOverviewASV("Site")
				.accountSummarycancelAppointment().logout();
	...
	public void ibJourneyToJoinASVOverdue() {
		...
		new ASVIBAction().loginUser(userProfile).navigateToAccountSummaryPage(
				...
				.navigateToIdentifyFault().navigateToReview(1)
				.continueWithASVIB().verifySlot("AM").verifyAddress(userProfile).selectAnAppointment("AM")
				.verifySlot("AM").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("AM").verifyAddressIB(userProfile).navigateTrackCancelChange().accountSummarycancelAppointment()
				.logout();
	...
	public void ibJourneyToJoinASVOverdueCOD() {
		...
		new ASVIBAction().loginUser(userProfile).navigateToAccountSummaryPage(
				userProfile).bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault().navigateToReview(1)
				.continueWithASVIB().verifySlot("PMElec").verifyAddress(userProfile).selectAnAppointment("PMElec")
				.verifySlot("PMElec").verifyAddress(userProfile).reviewDetailsPage().addCODASVIB(userProfile)
				.verifySlot("PMElec").verifyAddressIB(userProfile).navigateTrackCancelChange().accountSummarycancelAppointment()
				.logout();
	...
	public void ibJourneyToJoinASVOverdueGac() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASVIB(1).continueWithASVIB().verifySlot("EVE").verifyAddress(userProfile)
				.selectAnAppointment("EVE").verifySlot("EVE").verifyAddress(userProfile).reviewDetailsPage().addGAC()
				.navigateToConfirmationASV().verifySlot("EVE").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.accountSummarycancelAppointment().logout();
	...
	/*
//	 * Linking_TC_26 The user should be an OAM user. The user should have a BGS
	 * account. The scenario should be verified for a Homecare 100 account. Asv
	 * should be overdue Hc100
	 */
	...
	public void ibJourneyToJoinASVOverdueAllDay() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASVIB(0).continueWithASVIB().verifySlot("AllDay").verifyAddress(userProfile)
				.selectAnAppointment("AllDay").verifySlot("AllDay").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("AllDay").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.accountSummarycancelAppointment().logout();
	...
	public void ibJourneyToJoinASVOverdue12to2() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASVIB(1).continueWithASVIB().verifySlot("12to2").verifyAddress(userProfile)
				.selectAnAppointment("12to2").verifySlot("12to2").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("12to2").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.accountSummarycancelAppointment().logout();
	...
	public void ibBookBreakdownVerifyNavigationHc100() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").verifyAddressBook(userProfile).navigateToIdentifyFault(1)
				.navigatePriorityPageIB(1).verifyAddress(userProfile).verifySlot("AM").verifyAddress(userProfile)
				.selectAnAppointment("AM").verifySlot("AM").verifyAddress(userProfile).clickChangeAppointment().verifyAddress(userProfile)
	...
	public void ibBookBreakdownVerifyNavigationHc200() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAddressBook(userProfile).bookAnEngineer(userProfile,
						"IV").verifyAddressBook(userProfile).navigateToIdentifyFault(1)
				.navigatePriorityPageIB(1).verifySlot("EVE").verifyAddress(userProfile)
				.selectAnAppointment("EVE").verifySlot("EVE").verifyAddress(userProfile).clickChangeAppliance()
				.verifyAddress(userProfile).verifyFaultPage().logout();
	}
	...
	public void ibBookBreakdownVerifyNavigationHc200Std() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAddressBook(userProfile).bookAnEngineer(userProfile,
						"IV").verifyAddressBook(userProfile).navigateToIdentifyFault(1)
				.navigatePriorityPageIB(0).verifySlot("PM").verifyAddress(userProfile)
				.selectAnAppointment("PM").verifySlot("EVE").verifyAddress(userProfile).clickChangeAppliance()
				.verifyFaultPage().verifyAddress(userProfile).logout();
	}
	...
	public void ibBookBreakdownVerifyNavigation() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAddressBook(userProfile).verifyLinkNavigation(
						"ASV").navigateBack().verifyLinkNavigation(
						"IB").navigateBack().logout();
	...
	public void AllocStatusIB() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.continueWithASV().verifySlot("AM").verifyAddress(userProfile).selectAnAppointment("AM")
				.verifySlot("AM").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("AM").verifyAddressIB(userProfile).navigateTrackCancelChangeBook().verifyAccountOverviewASV("ALLOC")
				.accountSummarycancelAppointment().logout();
	...
	public void ibJourneyForEveDaysSlotsHc100() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault().navigateToReview(1)
				.continueWithASV().verifySlot("EVE").verifyAddress(userProfile).selectAnAppointment("EVE")
				.verifySlot("EVE").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("EVE").verifyAddressIB(userProfile).navigateTrackCancelChangeBook().verifyAccountOverviewASV("EVE")
				.viewDetailsBook().verifyAccountOverviewASV("EVE")
				.accountSummarycancelAppointment().logout();
	...
	public void ibBookABreakdownBS2ALLOCStatus() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.clickFaultCategory("Gas").navigateToIdentifyFault(1)
				.navigatePriorityPageBook(1).navigateToReviewIB(1).verifySlot("AllDay").verifyAddress(userProfile)
				.selectAnAppointment("AllDay").verifySlot("AllDay").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("AllDay").verifyAddressIB(userProfile).navigateTrackCancelChangeBook()
	...
	public void ibBookABreakdownBS2COMPStatus() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineerIB(
						userProfile, "IV").clickFaultCategory("Electric")
				.clickFaultCategory("Gas").navigateToIdentifyFault(1)
				.navigatePriorityPageBook(1).navigateToReviewIB(1).verifySlot("AM").verifyAddress(userProfile)
				.selectAnAppointment("AM").verifySlot("AM").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("AM").verifyAddressIB(userProfile).navigateTrackCancelChangeBook()
	...
	public void ibBookABreakdownBS2SCHEDStatus() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineerIB(
						userProfile, "IV").clickFaultCategory("Electric")
				.clickFaultCategory("Gas").navigateToIdentifyFault(1)
				.navigatePriorityPageBook(1).navigateToReviewIB(1).verifySlot("PM").verifyAddress(userProfile)
				.selectAnAppointment("PM").verifySlot("PM").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("PM").verifyAddressIB(userProfile).navigateTrackCancelChangeBook()
				.verifyAccountOverviewASV("Sched")
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibBookBreakdownVerifyNavigationBS2EVE() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASV(1).navigateToReviewIB(1).verifySlot("EVE").verifyAddress(userProfile)
				.selectAnAppointment("EVE").verifySlot("EVE").verifyAddress(userProfile).clickChangeAppointment()
	...
	public void ibBookBreakdownVerifyNavigationBS2FF() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASV(1).navigateToReviewIB(1).verifySlot("FF").verifyAddress(userProfile)
				.selectAnAppointment("FF").verifySlot("FF").verifyAddress(userProfile).clickChangeAppliance()
				.verifyAddress(userProfile).verifyCalendarPage().logout();
	}
	...
	public void ibBookBreakdownVerifyNavigationBS2EVEStd() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASV(0).navigateToReviewIB(1).verifySlot("EVE").verifyAddress(userProfile)
				.selectAnAppointment("EVE").verifySlot("FF").verifyAddress(userProfile).clickChangeAppointment()
				.verifyAddress(userProfile).verifyCalendarPage().logout();
	}
	...
	public void ibBookingWithIbChangeApplianceBS1Hc100() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPageIB(1)
				.verifySlot("AM").verifyAddress(userProfile).selectAnAppointment("AM")
				.verifySlot("AM").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("AM").verifyAddressASVIB(userProfile).logoutReturn()
				.navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASV(1)
				...
				.clickChangeAppliance().verifyAddress(userProfile).verifyFaultPageASVIB().logoutReturn()
				.navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV()
				.accountSummarycancelAppointment().logout();
	...
	public void ibBookingWithIbChangeApplianceBS1HC200() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPageIB(1)
				.verifySlot("10to12").verifyAddress(userProfile).selectAnAppointment("10to12")
				.verifySlot("10to12").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("10to12").verifyAddressASVIB(userProfile).logoutReturn()
				.navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASV(1)
	...
	public void ibBookingWithIbChangeApplianceBS1HC300() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPageASV(1)
				.verifyAddressIB(userProfile).selectAnAppointment("10to12")
				.verifySlot("10to12").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("10to12").verifyAddressASVIB(userProfile).navigateTrackCancelChangeBook().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASV(1).changeAppointmentIB(2).verifySlot("10to12").verifyAddress(userProfile).selectAnAppointment("10to12")
				.verifySlot("10to12").verifyAddress(userProfile).reviewDetailsPage().clickChangeAppointment()
				.verifyAddress(userProfile).verifyCalendarPageASVIB()
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibBookingWithIbChangeApplianceBS1DISP() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPageASV(1)
				.navigateToReviewIB(1).verifySlot("6to8").verifyAddress(userProfile).selectAnAppointment("6to8")
				.verifySlot("6to8").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV()
				.verifySlot("6to8").verifyAddressASVIB(userProfile).logoutReturn()
				.navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASV(1)

				.changeAppointmentIB(2).verifySlot("6to8").verifyAddress(userProfile).selectAnAppointment("6to8")
				.verifySlot("6to8").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("6to8").verifyAddressIB(userProfile).navigateTrackCancelChangeBook().verifyAccountOverview("DISP")
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibBookingWithIbChangeApplianceBS1Na1Na2() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.changeAppointmentIB(2).verifySlot("6to8").verifyAddress(userProfile).selectAnAppointment("PM2to4")
				.verifySlot("6to8").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("6to8").verifyAddressIB(userProfile).navigateTrackCancelChangeBook().verifyAccountOverview("Na1")
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibBookingWithIbChangeApplianceBS1Sched() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.changeAppointmentIB(2).verifySlot("6to8").verifyAddress(userProfile).selectAnAppointment("6to8")
				.verifySlot("6to8").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("6to8").verifyAddressIB(userProfile).navigateTrackCancelChangeBook().verifyAccountOverview("Sched")
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibBookingWithIbChangeApplianceBS1Alloc() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPageASV(1)
				.navigateToReviewIB(1).verifySlot("10to12").verifyAddress(userProfile).selectAnAppointment("10to12")
				.verifySlot("10to12").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("10to12").verifyAddressIB(userProfile).logoutReturn()
				.navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASV(1)

				.changeAppointmentIB(2).verifySlot("10to12").verifyAddress(userProfile).selectAnAppointment("10to12")
				.verifySlot("10to12").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("10to12").verifyAddressIB(userProfile).navigateTrackCancelChangeBook().verifyAccountOverview("ALLOC")
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibBookingWithIbChangeApplianceBS1Site() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.changeAppointmentIB(2).verifySlot("10to12").verifyAddress(userProfile).selectAnAppointment("10to12")
				.verifySlot("10to12").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("10to12").verifyAddressIB(userProfile)
	...
	public void ibBookingWithIbChangeApplianceBS1Comp() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPageASV(1)
				.navigateToReviewIB(1).verifySlot("8to10").verifyAddress(userProfile).selectAnAppointment("8to10")
				.verifySlot("8to10").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("8to10").verifyAddressIB(userProfile).logoutReturn()
				.navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASV(1)

				.changeAppointmentIB(2).verifySlot("8to10").verifyAddress(userProfile).selectAnAppointment("8to10")
				.verifySlot("8to10").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("8to10").verifyAddressIB(userProfile).navigateTrackCancelChangeBook().verifyAccountOverview("COMP")
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibBookingWithIbChangeApplianceBS1Hold() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPageASV(1)
				.navigateToReviewIB(1).verifySlot("PM2to4").verifyAddress(userProfile).selectAnAppointment("PM2to4")
				.verifySlot("PM2to4").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("PM2to4").verifyAddressIB(userProfile).logoutReturn()
				.navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASV(1)

				.changeAppointmentIB(2).verifySlot("PM2to4").verifyAddress(userProfile).selectAnAppointment("PM2to4")
				.verifySlot("PM2to4").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("PM2to4").verifyAddressIB(userProfile).navigateTrackCancelChangeBook().verifyAccountOverview("Hold")
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibBookingWithIbChangeApplianceBS1Route() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPageASV(1)
				.navigateToReviewIB(1).verifySlot("PMElec").verifyAddress(userProfile).selectAnAppointment("PMElec")
				.verifySlot("PMElec").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("PMElec").verifyAddressIB(userProfile).logoutReturn()
				.navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASV(1)
				...
				.verifySlot("PMElec").verifyAddress(userProfile).selectAnAppointment("PMElec")
				.verifySlot("PMElec").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("PMElec").verifyAddressIB(userProfile).navigateTrackCancelChangeBook().verifyAccountOverview("Route")
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibBookingWithIbChangeApplianceBS1() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault().navigatePriorityPageIB(0).verifySlot("PMElec").verifyAddress(userProfile)
				.selectAnAppointment("PMElec").verifySlot("PMElec").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("PMElec").verifyAddressIB(userProfile).logoutReturn().navigateToLogin()
				.loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1)
				.navigatePriorityPageASV(1)
				...
				.selectAnyAppointment().reviewDetailsPage()
				.verifyFaultPageASVIB().accountSummarycancelAppointment()
				.logout();
	}
	...
	public void ibBookingWithIbChangeApplianceBS1FromCalendar() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault().navigatePriorityPageIB(0)
				.verifySlot("AM").verifyAddress(userProfile).selectAnAppointment("AM")
				.verifySlot("AM").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV()
				.verifySlot("AM").verifyAddressIB(userProfile).navigateTrackCancelChangeBook().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1).navigatePriorityPageASV(1)

				.changeAppointmentIB(2).clickChangeAppliance().verifySlot("AM").verifyAddress(userProfile)
				.selectAnAppointment("AM").verifySlot("AM").verifyAddress(userProfile).reviewDetailsPage()
				.clickChangeAppliance().verifyAddress(userProfile).verifyFaultPageASVIB().accountSummarycancelAppointment()
				.logout();
	}
	...
	public void ibBookingWithIbDifferentAppointmentBS1() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPageASV(1)
				.navigateToReviewIB(1).verifySlot("12to2").verifyAddress(userProfile).selectAnAppointment("12to2")
				.verifySlot("12to2").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("12to2").verifyAddressIB(userProfile).logoutReturn()
				.navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPageASV(1)

				.changeAppointmentIB(2).verifySlot("12to2").verifyAddress(userProfile).selectAnAppointment("12to2")
				.verifySlot("12to2").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
	...
	public void ibBookingWithIbKeepAppointmentBS1() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.changeAppointmentIB(1).reviewDetailsPage()
	...
	public void ibBookingWithIbDifferentAppointmentBS2() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPageASV(1)
				.navigateToReviewIB(1).verifySlot("AM").verifyAddress(userProfile).selectAnAppointment("AM")
				.verifySlot("AM").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				...
				.changeAppointmentIB(2).verifySlot("AM").verifyAddress(userProfile).selectAnAppointment("AM")
				.verifySlot("AM").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("AM").verifyAddressIB(userProfile).navigateTrackCancelChangeBook()
				.accountSummarycancelAppointment().logout();
	...
	public void ibBookingWithIbDifferentAppointmentBS28to10slot() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.navigateToReviewIB(1).verifySlot("8to10").verifyAddress(userProfile).selectAnAppointment("8to10")
				.verifySlot("8to10").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("8to10").verifyAddressASVIB(userProfile).logoutReturn()
				.navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPageASV(1)
				...
				.changeAppointmentIB(2).verifySlot("8to10").verifyAddress(userProfile).selectAnAppointment("8to10")
				.verifySlot("8to10").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("8to10").verifyAddressIB(userProfile).navigateTrackCancelChangeBook()
				.accountSummarycancelAppointment().logout();
	...
	public void ibBookingWithIbBS2DISP() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPageASV(1)
				.navigateToReviewIB(1).selectAnAppointment("AM")
				.reviewDetailsPage().navigateToConfirmationASV().logoutReturn()
				.navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1)
	...
	public void ibBookingWithIbBS2Route() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPageASV(1)
				.navigateToReviewIB(1).selectAnAppointment("PM")
				.reviewDetailsPage().navigateToConfirmationASV().logoutReturn()
				.navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault(1)
	...
	public void ibBookingWithIbDifferentAppointmentBS22HrSlot() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPageASV(1)
				.navigateToReviewIB(1).selectAnAppointment("12to2")
				.reviewDetailsPage().navigateToConfirmationASV().logoutReturn()
				.navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
	...
	public void ibBookingWithIbDifferentAppointmentBS2PMSlot() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPageIB(0)
.verifySlot("PM").verifyAddress(userProfile)
				.selectAnAppointment("PM").verifySlot("PM").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV()
				.verifySlot("PM").verifyAddressIB(userProfile).logoutReturn().navigateToLogin()
				.loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPageASV(0)

				.changeAppointmentIB(2).verifySlot("PM").verifyAddress(userProfile).selectAnAppointment("PM")
				.verifySlot("PM").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("PM").verifyAddressIB(userProfile).navigateTrackCancelChangeBook()
				.accountSummarycancelAppointment().logout();
	...
	public void ibBookingWithIbDifferentAppointmentBS2NAW() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.verifySlot("12to2").verifyAddress(userProfile).selectAnAppointment("12to2")
				.reviewDetailsPage().verifySlot("12to2").verifyAddress(userProfile).navigateToConfirmationASV()
				.verifySlot("12to2").verifyAddressIB(userProfile).logoutReturn()
				.navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				...
				.changeAppointmentIB(2).verifySlot("12to2").verifyAddress(userProfile).selectAnAppointment("12to2")
				.verifySlot("12to2").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("12to2").verifyAddressIB(userProfile).navigateTrackCancelChangeBook().verifyAccountOverview("Hold")
				.accountSummarycancelAppointment().logout();
	...
	public void ibBookingWithIbDifferentAppointmentBS2Alloc() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.navigateToIdentifyFault(1).navigatePriorityPageASV(1)
				.navigateToReviewIB(1)
				.verifySlot("AllDay").verifyAddress(userProfile).selectAnAppointment("AllDay")
				.verifySlot("AllDay").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("AllDay").verifyAddressIB(userProfile).logoutReturn()
				.navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault(1).navigatePriorityPageASV(1)

				.changeAppointmentIB(2).verifySlot("AllDay").verifyAddress(userProfile).selectAnAppointment("AllDay")
				.verifySlot("AllDay").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("AllDay").verifyAddressIB(userProfile).navigateTrackCancelChangeBook().verifyAccountOverview("ALLOC")
				.accountSummarycancelAppointment().logout();
	...
	public void ibBookingWithIbDifferentAppointmentBS2Site() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.changeAppointmentIB(2).verifySlot("AM").verifyAddress(userProfile).selectAnAppointment("AM")
				.verifySlot("AM").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("AM").verifyAddressIB(userProfile).navigateTrackCancelChangeBook().verifyAccountOverview("Site")
				.accountSummarycancelAppointment().logout();
	...
	public void ibCancelFromViewwithGAC() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverview(
						"ideal").bookAnEngineer(userProfile, "IV")
				.navigateToIdentifyFault().navigateToReviewIB(1)
				.selectAnyAppointment().reviewDetailsPage().addGAC()
				.navigateToConfirmationBooking().navigateTrackCancelChange()
				.viewDetailsCompletePage(userProfile)
				.accountSummarycancelAppointmentViewDetail().logout();
	...
	public void ibRescheduleBS2HC400FFSlot() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.navigateToReviewIB(2).verifySlot("FF").verifyAddress(userProfile).selectAnAppointment("FF")
				.verifySlot("FF").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("FF").verifyAddressIB(userProfile).navigateTrackCancelChange().accountSummarycancelAppointment()
				.logout();
	}
	...
	public void ibRescheduleBS2HC400AMslotSched() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.selectAnAppointment("AM").verifySlot("AM").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("AM").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.accountSummaryChangeAppointment().navigateToReviewIB(2).verifySlot("AM").verifyAddress(userProfile)
				.selectAnAppointment("AM").verifySlot("AM").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("AM").verifyAddressIB(userProfile).navigateTrackCancelChangeBook()
	...
	public void ibRescheduleBS2HC400AMslotPend() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault().navigateToReviewIB(1)
				.verifySlot("PM").verifyAddress(userProfile).selectAnAppointment("PM")
	...
	public void ibRescheduleBS2HC400AMslotDisp() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.selectAnAppointment("AM").verifySlot("AM").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV()
				.verifySlot("AM").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.accountSummaryChangeAppointment().navigateToReviewIB(2).verifySlot("AM").verifyAddress(userProfile)
				.selectAnAppointment("AM").verifySlot("AM").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("AM").verifyAddressIB(userProfile).navigateTrackCancelChangeBook()
	...
	public void ibRescheduleBS2HC400FFslotHold() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault().navigateToReviewIB(1)
				.selectAnAppointment("FF").reviewDetailsPage()
				.navigateToConfirmationASV().navigateTrackCancelChange()
				.accountSummaryChangeAppointment().navigateToReviewIB(2)
				.verifySlot("FF").verifyAddress(userProfile)
				.selectAnAppointment("FF").verifySlot("FF").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("FF").verifyAddressIB(userProfile).navigateTrackCancelChangeBook()
	...
	public void ibRescheduleBS2HC400AMslotComp() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.verifySlot("AM").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.accountSummaryChangeAppointment().navigateToReviewIB(2).verifySlot("AM").verifyAddress(userProfile)
				.selectAnAppointment("AM").reviewDetailsPage().verifySlot("AM").verifyAddress(userProfile)
				.navigateToConfirmationASV().verifySlot("AM").verifyAddressIB(userProfile).navigateTrackCancelChangeBook()
	...
	public void ibRescheduleBS2HC400PMslotNa1Na2() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.navigateToReviewIB(2)
				.verifySlot("PM").verifyAddress(userProfile).selectAnAppointment("PM")
				.verifySlot("PM").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("PM").verifyAddressIB(userProfile).navigateTrackCancelChangeBook().verifyAccountOverview("Na1")
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibRescheduleBS2HC400AMslotNaw() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().verifyAccountOverviewASV(
						"Ideal").accountSummaryChangeAppointment()
				.navigateToReviewIB(2).verifySlot("AM").verifyAddress(userProfile).selectAnAppointment("AM")
				.verifySlot("AM").verifyAddress(userProfile).reviewDetailsPage().navigateToConfirmationASV()
				.verifySlot("AM").verifyAddressIB(userProfile).navigateTrackCancelChangeBook().verifyAccountOverview("Naw")
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibRescheduleBS2VerifyChangeAppliance() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.selectAnAppointment("8to10").verifySlot("8to10").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV()
				.verifySlot("8to10").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.viewDetails().accountSummarycancelAppointment()
				.navigateToReviewIB(2).verifySlot("8to10").verifyAddress(userProfile).selectAnAppointment("8to10")
				.verifySlot("8to10").verifyAddress(userProfile).clickChangeAppointment().verifyAddress(userProfile).verifyCalendarPage().logout();
	...
	public void ibRescheduleBS1VerifyChangeAppliance() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.clickChangeAppointment().verifyCalendarPage()
				//.logout()
				;
	...
	public void ibRescheduleBS1HC100PMslotSched() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageIB()/*.bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault().navigateToReviewIB(1)
						.verifySlot("PM").verifyAddress(userProfile)
				.selectAnAppointment("PM").verifySlot("PM").verifyAddress(userProfile).reviewDetailsPage()
	...
	public void ibRescheduleBS1HC300AllDayslotDisp() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.selectAnAppointment("AllDay").reviewDetailsPage().verifySlot("AllDay").verifyAddress(userProfile)
				.navigateToConfirmationASV().verifySlot("AllDay").verifyAddressIB(userProfile).navigateTrackCancelChange()
				.accountSummaryChangeAppointment().navigateToReviewIB(2).verifySlot("AllDay").verifyAddress(userProfile)
				.selectAnAppointment("AllDay").verifySlot("AllDay").verifyAddress(userProfile).reviewDetailsPage()
				.verifySlot("AllDay").verifyAddress(userProfile).navigateToConfirmationASV()
				.verifySlot("AllDay").verifyAddressIB(userProfile).navigateTrackCancelChangeBook()
				.verifyAccountOverview("DISP")
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibRescheduleBS1HC100FFslotPend() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.selectAnAppointment("FF").verifySlot("FF").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV()*/.verifyAddressIB(userProfile).verifySlotBook("FF")
				.verifyAccountOverview("Pend")
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibRescheduleBS1HC300AllDayslotCompp() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.accountSummaryChangeAppointment().navigateToReviewIB(2).verifySlot("AllDay").verifyAddress(userProfile)
				.selectAnAppointment("AllDay").verifySlot("AllDay").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV()*/.verifyAddress(userProfile).verifySlotBook("AllDay")
				.verifyAccountOverview("Comp")
				.accountSummarycancelAppointment().logout();
	}
	...
	public void ibEmailConfirmationCancelIB() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				...
				.reviewDetailsPage().addCODASVIB(userProfile)
				.navigateTrackCancelChangeBook()
	...
	public void ibEmailConfirmationBookIB() {
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineer(userProfile,
						"IV").navigateToIdentifyFault().navigateToReviewIB(1).verifySlot("AllDay").verifyAddress(userProfile)
				.selectAnAppointment("AllDay").verifySlot("AllDay").verifyAddress(userProfile).reviewDetailsPage()
				.navigateToConfirmationASV().verifySlot("AllDay").verifyAddressIB(userProfile).navigateTrackCancelChangeIB()
	 ...
	 */
	@Test(groups = { ASVIB, Regression })
	public void mulitJobsIBBS1BS2() {
		Report.createTestLogHeader(
				"Multiple Status Bar Controls - IB Journey Test -BS1 & BS2",
				"HomeSerivcesAccount");
		UserProfile userProfile = new TestDataHelper()
				.getUserProfile("HomeServciesAccount");
		...
		new HomePageAction().navigateToLogin().loginUserDetails(userProfile)
				.navigateToAccountSummaryPageASV().bookAnEngineerIB(
						userProfile, "IV").verifyFaultPage()
				.clickFaultCategory("Home Electrics").clickFaultItemCheck()
	 ...
	 */
	@Test(groups = { ASVIB, Regression })
	public void mulitJobsIBDiffAddress() {
		Report
				.createTestLogHeader(
						"Multiple Status Bar Controls - IB Journey Test - Different Address",
						"HomeSerivcesAccount");
		UserProfile userProfile = new TestDataHelper()
				.getUserProfile("HomeServciesAccount");
