...
public class TestDataHelper {
    ...
    private static final String AddAdditionalAccountsDetailsXMLFile = "resources/TestData/bgb/AddAdditionalAccounts.xml";
    private static final String makeAPaymentCardDetailsXMLFile = "resources/TestData/bgb/MakeAPaymentCardDetails.xml";
    ...
    private Map<String, AddAdditionalAccounts> allAddAdditionalAccounts=new HashMap<String, AddAdditionalAccounts>();
    ...
    public TestDataHelper() {
        ...
        xStream.processAnnotations(AddAdditionalAccounts.class);
  ...
  //Bgb - Slingshot
    ...
    //Bgb - Wave 
    @SuppressWarnings(value="unchecked")
    public Map<String, AddAdditionalAccounts> getallAddAdditionalAccounts(boolean reloadRequired){
    	if(allAddAdditionalAccounts.isEmpty() || reloadRequired){
    		allAddAdditionalAccounts=(Map<String, AddAdditionalAccounts>) xStream.fromXML(readTestDataXml(AddAdditionalAccountsDetailsXMLFile));
    	}
    	return allAddAdditionalAccounts;
    }
    
    public AddAdditionalAccounts getAddAdditionalAccounts(String profileKey){
    	if(allAddAdditionalAccounts.isEmpty()){
    		getallAddAdditionalAccounts(false);
    	}
    	return allAddAdditionalAccounts.get(profileKey);
    }
    @SuppressWarnings(value="unchecked")
