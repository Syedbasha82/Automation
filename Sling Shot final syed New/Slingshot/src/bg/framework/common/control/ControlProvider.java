...
public final class ControlProvider {
    ...
    private static UIControl controlType(String elementType, WebElement webElementControl, String id) {
        ...
        controlMap.put("tel", new ClickableControl(webElementControl));  
        controlMap.put("area", new ClickableControl(webElementControl));
        controlMap.put("option", new ClickableControl(webElementControl));
        controlMap.put("p", new TextBoxControl(webElementControl));
        controlMap.put("li", new ClickableControl(webElementControl));
        controlMap.put("ul", new ClickableControl(webElementControl));
        controlMap.put("tel", new TextAreaControl(webElementControl));
        controlMap.put("input", new ClickableControl(webElementControl));
        controlMap.put("form", new ClickableControl(webElementControl));
        controlMap.put("u", new ClickableControl(webElementControl));
