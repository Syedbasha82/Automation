...
public class UIOperation {
    ...
    {
    	uiDriver.findElement(By.xpath("//*[@name='email']")).sendKeys(name);
    }
    
    public void EnterPassword(String name)
    {
    	uiDriver.findElement(By.xpath("//*[@name='password']")).sendKeys(name);
    }
    
    public void clicksubmit()
    {
    	uiDriver.findElement(By.xpath("//*[@class='text-center']//*[@type='submit']")).click();
    }
    
    public void RegistrationInputEmailID(String name)
    {
    	uiDriver.findElement(By.xpath("//*[@name='email']")).sendKeys(name);
    }
    
    public void RegistrationConfirmEmailID(String name)
    {
    	uiDriver.findElement(By.xpath("//*[@name='emailConfirmation']")).sendKeys(name);
    }
    
    public void DDAccountNumber(String name)
    {
    	uiDriver.findElement(By.xpath("//*[contains(@name,'paymentCard')]")).sendKeys(name);
    }
 ...
 public String getTitle(){
	...
	*/
	...
	public void swithnewwindow_getTitle()
	{
		...
		Report.updateTestLog("New Window Title name is appreared As Expected"+getWindowTitle(),"WARN");
		uiDriver.close();
...
public String selectdropdownoptionby_value(String xpath,String value) {
	System.out.println("pppppppppppppppppppppppppppppppppppp");
	Select select;
	String usertypevalue=null;
	try{
		select = new Select(uiDriver.findElement(By.xpath(xpath)));
		System.out.println("assigned");
...
public String selectdropdownoptionbyindex_id(String id,int value) {
	Select select;
	String usertypevalue=null;
	try{
		select = new Select(uiDriver.findElement(By.id(id)));
		System.out.println("assigned");
		select.selectByIndex(value);
		System.out.println("selected");		
	}
...
public void clearValueByCss(String css) {
    UIControl controlType = new ControlProvider().getControl(new FindByCss(css));
    controlType.clearValue();
}
public void inputByCss(String css, String value) {
