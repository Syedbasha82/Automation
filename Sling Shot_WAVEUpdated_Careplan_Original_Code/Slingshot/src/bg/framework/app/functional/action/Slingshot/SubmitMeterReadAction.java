...
//	}
	//SAP Gas
		public SubmitMeterReadAction verifyAnonymousSAPGasCustomers(SMRAccountDetails smrProfile){
			SubmitMeterReadPage smrpage = new SubmitMeterReadPage();
			smrpage.enterValidData_Anonymous(smrProfile);
			smrpage.getDialsCountAndSubmitMeterRead(smrProfile,1);// input 1 for sap verification and 0 for no need verify
		    smrpage.verifyGasReadConfirmationPageTitle();
			return this;
		}
		// SAP electric
...
/*	public SubmitMeterReadAction enterMeterDial1(SMRAccountDetails smrProfile){
	...
	public SubmitMeterReadAction searchBySSupplynumber(SMRAccountDetails smrProfile) {
		SubmitMeterReadPage smrpage = new SubmitMeterReadPage();
		smrpage.searchBySSupplynumber(smrProfile);		
		return this;
	}
...
//****************************************************** sundar script*****************************
	...
	public  SubmitMeterReadAction submitMeterReadLink(){
		new SubmitMeterReadPage(). clickSubmitMeterReadlink();
		return this;
	}
