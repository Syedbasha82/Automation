...
public class ManagePersonalDetailsPage extends BasePage {
    ...
    public void fillValidDataInManagePersonalDetailsPage(UserProfile userProfile) {
        ...
        strEmail = "digital_ssrv" + intRandomNumbers + "@bgdigitaltest.co.uk";
        System.out.print("digital_ssrv" + intRandomNumbers + "@bgdigitaltest.co.uk");
       ...
       // verifyAndInputById(pageProperties.getProperty("ManagePersonalDetails.ReEnterEmailAddress"), "ReEnterEmailAddress Field", "automation_sele" + intRandomNumbers + "@bgdigitaltest.co.uk");
        ...
        verifyAndInputById(pageProperties.getProperty("ManagePersonalDetails.NewPassword"), "NewPassword Field", "password12");
        verifyAndInputById(pageProperties.getProperty("ManagePersonalDetails.ConfirmNewPassword"), "ConfirmNewPassword Field", "password12");
        userProfile.setPassword("password12");
        verifyAndInputById(pageProperties.getProperty("ManagePersonalDetails.MobileNumber"), "MobileNumber Field", "0122226789");
        verifyAndInputById(pageProperties.getProperty("ManagePersonalDetails.HomeNumber"), "HomeNumber Field", "0112232679");
        verifyAndInputById(pageProperties.getProperty("ManagePersonalDetails.WorkNumber"), "WorkNumber Field", "0999999999");
