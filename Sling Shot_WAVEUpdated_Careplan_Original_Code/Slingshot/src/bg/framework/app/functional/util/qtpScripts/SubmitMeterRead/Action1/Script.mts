...
If SAPGuiSession("Session").SAPGuiWindow("wndLicenseInformation").SAPGuiRadioButton("rdbContinuewiththislogon").Exist Then
	SAPGuiSession("Session").SAPGuiWindow("wndLicenseInformation").SAPGuiRadioButton("rdbContinuewiththislogon").Set
SAPGuiSession("Session").SAPGuiWindow("wndLicenseInformation").SAPGuiButton("btnConfirmSelection").Click
End If
 wait(5)
	    Dim fso, f
...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
     Function getLastMeterReadValue()
		 ...
		 strLastMrReadingDate=SAPGuiSession("Session").SAPGuiWindow("wndBillingViewofInstallation").SAPGuiGrid("grdBillingRelevantMeterReading").GetCellData(2,"Meter reading date")
		 objFile.WriteLine ("LastMeterReadingDate :")&strLastMrReadingDate

		 strLastMrReadValue=Trim(SAPGuiSession("Session").SAPGuiWindow("wndBillingViewofInstallation").SAPGuiGrid("grdBillingRelevantMeterReading").GetCellData(2,"Meter read. f. billing"))
